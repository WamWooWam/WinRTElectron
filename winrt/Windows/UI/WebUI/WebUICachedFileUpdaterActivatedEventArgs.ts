...
import { ICachedFileUpdaterActivatedEventArgs } from "../../ApplicationModel/Activation/ICachedFileUpdaterActivatedEventArgs";
...
@GenerateShim('Windows.UI.WebUI.WebUICachedFileUpdaterActivatedEventArgs')
export class WebUICachedFileUpdaterActivatedEventArgs implements ICachedFileUpdaterActivatedEventArgs, IActivatedEventArgs, IActivatedEventArgsDeferral { 
