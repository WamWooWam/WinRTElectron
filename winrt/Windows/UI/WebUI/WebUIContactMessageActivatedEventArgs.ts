...
import { IContactMessageActivatedEventArgs } from "../../ApplicationModel/Activation/IContactMessageActivatedEventArgs";
...
@GenerateShim('Windows.UI.WebUI.WebUIContactMessageActivatedEventArgs')
export class WebUIContactMessageActivatedEventArgs implements IContactMessageActivatedEventArgs, IContactActivatedEventArgs, IActivatedEventArgs, IActivatedEventArgsDeferral { 
    verb: string = null;
