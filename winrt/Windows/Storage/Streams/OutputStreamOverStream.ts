...
@GenerateShim('Windows.Storage.Streams.OutputStreamOverStream')
export class OutputStreamOverStream implements IOutputStream, IClosable { 
    writeAsync(buffer: IBuffer): IAsyncOperationWithProgress<number, number> {
        throw new Error('OutputStreamOverStream#writeAsync not implemented')
    }
    flushAsync(): IAsyncOperation<boolean> {
        throw new Error('OutputStreamOverStream#flushAsync not implemented')
    }
    close(): void {
        console.warn('OutputStreamOverStream#close not implemented')
    }
}
