...
"use strict";
var STRINGS={
L2OPENED: "", CLICKTOOPENL2: ""
};
var NS=WinJS.Namespace.define("CommonJS", {SquareButton: WinJS.Class.define(function squareButton_ctor(element, options) {
...
element: null, buttonElement: null, toggleElement: null, parentId: null, channelId: null, isSubChannel: false, buttonContainerType: null, images: null, pressedIcon: null, _title: null, _label: null, _icon: null, _iconDiv: null, _buttonDiv: null, _active: false, _expanded: false, _hasSubChannels: false, _blurHandler: null, _focusHandler: null, _keyDownHandler: null, _toggleButtonColor: null, _iconRest: null, _doubleWide: null, _onClick: null, _onkeyDown: null, _visible: null, _onKeyDown: function _onKeyDown(event) {
...
imageSource: {
url: imageUrl, cacheId: "PlatformTopEdgyImageCache"
...
SINGLE: 0, DOUBLE: 2, SNAP: 3, HOIST: 4
}})})
})();
(function appexPlatformControlsSquareButtonContainerInit() {
"use strict";
var NS=WinJS.Namespace.define("CommonJS", {SquareButtonContainer: WinJS.Class.define(function squareButtonContainer_ctor(element, options) {
this.element = element || document.createElement("div");
...
_scrollAnimation: WinJS.Promise.wrap(null), _buttons: null, _maxWidth: 0, _maxHeight: 0, _scrollLeft: 0, _scrollTop: 0, _pageWidth: 0, _pageHeight: 0, _itemPerRow: null, _columnNum: null, _fullWidth: true, _map: null, _total: 0, _channelButtonGroups: null, _pageCountArray: null, _titleContainer: null, _pageContainer: null, _leftArrowContainer: null, _rightArrowContainer: null, _currentGroup: null, _inAutoScroll: false, element: null, wideScrollMode: true, title: null, activeGroupId: null, peak: null, pageControl: null, isEmpty: false, titleResource: null, buttonContainer: null, channelIdToSubGroupMap: null, active: {get: function get() {
...
button: button, count: channelCount
}
}
}
}
...
pageCount: pageCount, pageNo: pageNo, pageWidth: this._pageWidthForPagination
});
...
return container
}, MAXBUTTONGAP: 15, _calculateButtonWidthAndGap: function _calculateButtonWidthAndGap() {
...
return {
buttonWidth: buttonWidth, gap: gap, itemPerRow: itemPerRow
}
...
this._pageContainer.innerHTML = "";
this.pageControl = new CommonJS.PagingBar(null, {
pageCount: pageCount, pageWidth: this._pageWidthForPagination
});
this._pageContainer.appendChild(this.pageControl.element);
...
"use strict";
var NS=WinJS.Namespace.define("CommonJS", {PagingBar: WinJS.Class.define(function pagingBar_ctor(element, options) {
this.element = element || document.createElement("div");
...
_pageNo: null, _on: null, pageCount: null, pageNo: {
get: function get() {
return this._pageNo
}, set: function set(v) {
...
}, MAXPAGEBARWIDTH: 18, _init: function _init() {
var i=0;
var bar=null;
...
var NS=WinJS.Namespace.define("CommonJS", {NavigationBar: WinJS.Class.define(function navigationBar_ctor(element, options) {
var that=this;
...
title: CommonJS.getAppName(), id: CommonJS.getAppName()
});
...
titleResource: "/platform/viewing", id: "platform_viewing"
});
...
titleResource: "/platform/featured", id: "platform_featured"
});
WinJS.Utilities.addClass(featuredChannelBar.element, "featured");
featuredChannelBar.platformHidden = true;
var subChannelBar=this._subChannelBar = new CommonJS.NavBarContainer(null, {id: "subChannels"});
...
_mainChannelBar: null, _hoistChannelBar: null, _featuredChannelBar: null, _subChannelBar: null, _expandedButton: null, _hoistable: null, _animating: null, _tabKeypressHandler: null, element: null, _setMainChannels: function _setMainChannels(value) {
if (this._animating) {
...
var buttonDebugTools=document.createElement("button");
var buttonDebugToolsControl=new WinJS.UI.AppBarCommand(buttonDebugTools, {
icon: "\uE063", extraClass: "appexSymbol previewFeaturedDataSourceButton"
});
...
var message=new CommonJS.MessageBar('', {autoHide: true});
...
icon: "clear", extraClass: "appexSymbol", label: "PDP Delete"
});
...
icon: "\uE003", extraClass: "appexSymbol", label: "Update Version: Mandatory"
});
var buttonCheckUpdateNotForceControl=new WinJS.UI.AppBarCommand(buttonCheckUpdateNotForce, {
icon: "\uE003", extraClass: "appexSymbol", label: "Update Version: Optional"
});
...
code: Platform.Utilities.VersionUpdateUIType.forcedUpdate, message: JSON.stringify({
AppStoreUrl: "ms-windows-store:Updates", ForceUpdate: true
})
})
};
...
PlatformJS.mainProcessManager.showVersionUI(null, {
code: Platform.Utilities.VersionUpdateUIType.forcedUpdate, message: JSON.stringify({
AppStoreUrl: "ms-windows-store:Updates", ForceUpdate: false
})
})
};
...
icon: "\uE168", extraClass: "appexSymbol", label: "Dump Articles"
});
...
MAIN: standard, FEATURED: featured
});
...
WinJS.xhr({url: featuredChannel.displayInstrumentation}).done(null, function featuredDisplayInstrumentation_complete(){})
}
...
property: "height", delay: 0, duration: 120, timing: "linear", to: SUBCHANNELHeight
})
}
else {
...
property: "-ms-transform", delay: 0, duration: 120, timing: "linear", from: "", to: translate
})
}
else {
...
if (animate) {
animation = WinJS.UI.executeTransition(SUBCHANNEL, {
property: "height", delay: 0, duration: 120, timing: "linear", to: "0px"
})
}
else {
SUBCHANNEL.style.height = "0px";
...
property: "opacity", delay: 60, duration: 40, timing: "linear", from: 1, to: 0
});
var animation2=WinJS.UI.executeTransition(featured, {
property: "-ms-transform", delay: 0, duration: 120, timing: "linear", to: ""
});
...
ButtonType: buttonContainerTypeReverseMap[button.buttonContainerType], index: button.index
}));
...
WinJS.xhr({url: channel.hitInstrumentation}).done(null, function navBarButtonHitInstrumentation_complete(){})
}
...
property: "-ms-transform", delay: 0, duration: 500, timing: "ease", from: "translateX(-" + (scrollLeft - scrollMin) + "px)", to: "none"
});
...
ButtonContainerType: {
MAIN: 1, FEATURED: 2, HOIST: 3, SUBCHANNEL: 4
}, NavBarControl: null, buildNavBar: function buildNavBar() {
var that=this;
...
"use strict";
WinJS.Namespace.define("CommonJS", {NavBarContainer: WinJS.Class.derive(CommonJS.SquareButtonContainer, function navBarContainer_ctor(domElement, options) {
...
_activeChannel: null, _hasResized: false, _onEdgeGestureCompleted: function _onEdgeGestureCompleted() {
...
}, activeChannel: {get: function get() {
...
standardChannelsBootCacheKey: "CM.standardChannels", featuresChannelsBootCacheKey: "CM.featuredChannels", ChannelManager: WinJS.Class.define(function ChannelManager_ctor(processListeners) {
var that=this;
...
channels: null, standardChannels: null, featuredChannels: null, channelConfigChanged: {
get: function get() {
...
}, standardChannelChanged: false, featuredChannelChanged: false, _cloudFeaturedChannelsLoaded: false, reloadChannels: function reloadChannels() {
...
supportsInMemory: true, bypassInMemory: true
...
channel.pageInfo = {
channelId: id, fragment: this.standardChannels[k].pageInfo.fragment, page: this.standardChannels[k].pageInfo.page
};
break
}
}
...
channel.state = sources[i].state ? JSON.parse(sources[i].state) : {dynamicInfo: {
...
pageInfo: channel.pageInfo, state: channel.state
})
...
var channel=({
id: channelConfig.id, visible: channelConfig.visible === "true", title: title, icon: channelConfig.icon, context: channelConfig.context, pressedIcon: channelConfig.pressedIcon, pageInfo: {
...
var channel={
id: channelId, displayInstrumentation: navBarItem.displayinstrumentation, hitInstrumentation: navBarItem.hitinstrumentation, isDeepLink: true, images: {
single: navBarItem.partnerlogo, snap: navBarItem.partnerlogosnap, hoist: navBarItem.partnerlogohoisted
}, pageInfo: {
fragment: navBarItem.destination, channelId: channelId
}, subChannels: []
};
return channel
}
...
"use strict";
WinJS.Namespace.define("PlatformJS.Navigation", {
uriNavigationControllers: {}, entityViewMap: {}, isNoop: function isNoop(url) {
if (!url || url.length === 0) {
return true
}
else {
...
debugger;
if (!PlatformJS.Navigation._tryNavigationInfo(actionCommand)) {
command()
}
}
...
return PlatformJS.Navigation.createNavigationAction({channelId: "Home"})
...
Microsoft.Bing.AppEx.Telemetry.FlightRecorder.logCodeErrorWithJsonAttributes(Microsoft.Bing.AppEx.Telemetry.LogLevel.high, Microsoft.Bing.AppEx.Telemetry.RuntimeEnvironment.javascript, "VideoWrapper - Third party video - LaunchUriAsync error:" + error.message, error.stack, JSON.stringify({url: externalUrl}))
})
}
}
else {
...
var state={
url: externalUrl, instrumentationEntryPoint: "", impressionContext: "/Mediaplayback/Thirdpartyplayer"
};
...
"use strict";
var noopController={default: function navigation_noopController(args) {
return PlatformJS.Navigation.createNoopAction()
}};
...
"use strict";
WinJS.Namespace.define("PlatformJS.Navigation", {
mainNavigator: null, enablingDiskPaging: true, namespace: "PlatformJS.Navigation.", BackNavigation: "backNavigation", NewNavigation: "newNavigation", Navigator: WinJS.Class.define(function navigator_ctor(processListeners) {
...
canNavigate: true, currentIPage: null, lastIPage: null, channelManager: null, channelIDInView: null, weightedNavigationCounter: null, _loadFeaturesPromise: null, _pageArea: null, _currentStackSize: 0, _currentPageTimer: null, _lastChannelIdentifier: null, _lastSuspendedTime: null, _loadPagePromise: null, _appBarDiv: null, _backstackHistory: null, _forwardstackHistory: null, _lastContext: null, _currentLocation: null, _pendingPageLoadCall: false, _pendingPageLoadId: null, _beforeNavigating: function _beforeNavigating(event) {
...
complete({
state: state, readFromDisk: false
})
})
...
enable: enableLimitation, triggerSize: triggerSize, restrictionSize: restrictionSize
}
}
...
location: "", initialPlaceholder: true
};
this.canNavigate = true
...
this.notifyPageLoadComplete();
var error={
innerError: e, detail: JSON.stringify(detail), navigationHistory: JSON.stringify(history)
};
this.resetApp(error);
return
}
...
this._historyRestrictionConfig = {
enable: false, triggerSize: 0, restrictionSize: 0
};
...
return true
}, _permissionDeniedRetryCount: 0, _permissionDeniedRetryMax: 3, _adsClusterAddedListenerID: null
})
})
})();
(function appexPlatformWeightedNavigationCounterInit(WinJS) {
"use strict";
var NS=WinJS.Namespace.define("PlatformJS", {WeightedNavigationCounter: WinJS.Class.define(function weightedNavigationCounter_ctor() {
this._count = 0
}, {
_count: null, countWeightedNode: function countWeightedNode(node) {
