...
_currentMarketKey: "app.currentMarket", _currentMarket: null, _dominantMarketKey: "app.dominantMarket", _dominantMarket: null, _qualifiedLanguageKey: "app.qualifiedLanguage", _qualifiedLanguage: null, applicationSettingsNS: {get: function get() {
...
}}, longerLength: {get: function get() {
if (!this._initalized) {
this._compute()
}
;
return this._currentData._longerLength
}}, shorterLength: {get: function get() {
if (!this._initalized) {
this._compute()
}
;
return this._currentData._shorterLength
}}, outerHeight: {get: function get() {
if (!this._initalized) {
this._compute()
}
;
...
_dataPoints: null, DataPoints: {get: function get() {
...
}}, _dataSetId: null, DataSetId: {get: function get() {
...
"use strict";
WinJS.Namespace.define("PlatformJS.FeaturedPartners", {Sources: WinJS.Class.define(function sources_ctor() {
...
WinJS.Namespace.define("CommonJS.Partners", {Debug: WinJS.Class.define(function _utilities_3510() {
this.output = ""
}, {
...
"use strict";
WinJS.Namespace.define("PlatformJS", {BootCache: WinJS.Class.define(function BootCache_ctor() {
...
}, prefetchToggled: {get: function get() {
