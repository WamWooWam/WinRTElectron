...
(function appexBaseAuthInit() {
    ...
    WinJS.Namespace.define("CommonJS.Partners.Auth", {
        BaseAuth: WinJS.Class.define(function commonjs_baseauth_ctor() {
...
(function appexBaseAuthCtrlInit() {
    "use strict";
    WinJS.Namespace.define("CommonJS.Partners.Auth", {
        BaseAuthControl: WinJS.Class.define(function commonjs_baseauthctrl_ctor(options) {
            var that = this;
...
(function appexBaseAuthInit() {
    "use strict";
    WinJS.Namespace.define("CommonJS.Partners.Auth", {
        BaseWebAuthControl: WinJS.Class.derive(CommonJS.Partners.Auth.BaseAuthControl, function commonjs_basewebauthctrl_ctor(options) {
            this._url = null;
...
(function appexBaseNativeAuthInit() {
    "use strict";
    WinJS.Namespace.define("CommonJS.Partners.Auth", {
        BaseNativeAuthControl: WinJS.Class.derive(CommonJS.Partners.Auth.BaseAuthControl, function commonjs_basenativeauthctrol_ctor(options) {
            CommonJS.Partners.Auth.BaseAuthControl.call(this, options);
...
(function _DynamicPanoAuth_1() {
    ...
    WinJS.Namespace.define("DynamicPanoJS", {
        AuthControl: WinJS.Class.derive(CommonJS.Partners.Auth.BaseNativeAuthControl, function dynamic_pano_auth_ctrl_ctor(options) {
            ...
            _instrumentationId: null, authInfo: null, _authStatus: null, authStatus: {
                get: function get() {
                    if (!this._authStatus) {
                        try {
...
(function _PaywallControlFactory_6() {
    "use strict";
    WinJS.Namespace.define("CommonJS.Partners.Auth.PaywallControlFactory", {
        createPaywallControl: function createPaywallControl(paywallProvider, instrumentationId) {
...
(function _RestPaywallControl_6() {
    "use strict";
    WinJS.Namespace.define("CommonJS.Partners.Auth", {
        RestPaywallControl: WinJS.Class.derive(CommonJS.Partners.Auth.PaywallControlBase, function restpaywallcontrol_ctor(element, options) {
...
(function _OAuthPaywallControl_6() {
    ...
    WinJS.Namespace.define("CommonJS.Partners.Auth", {
        OAuthPaywallControl: WinJS.Class.derive(BaseControl, function restpaywallcontrol_ctor(element, options) {
            var paywallSettings = options.paywallProvider.paywallSettings;
