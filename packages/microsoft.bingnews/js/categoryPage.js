...
(function() {
"use strict";
WinJS.Namespace.define("NewsJS", {CategoryPage: WinJS.Class.derive(NewsJS.SourcesContentBasePage, function(state) {
...
that.itemInvoked(e)
}, providerId: defaultProviderIdFromConfig, adLayoutOverrideKey: !this._isHomeMarket ? "noad" : null, dataSet: cmsDataResults, theme: "newsAppTheme", configKey: "EntityClusterDefaultNewsConfig", configObject: CommonJS.News.EntityClusterConfig.DefaultNews, telemetry: {getCurrentImpression: function getCurrentImpression() {
