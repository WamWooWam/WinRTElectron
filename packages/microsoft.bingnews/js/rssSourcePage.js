...
(function () {
    ...
    WinJS.Namespace.define("NewsJS", {
        RSSSourcePage: WinJS.Class.derive(NewsJS.SourceBasePage, function (state) {
                        ...
                        that._clusters.push({
                            clusterKey: clusterKey, clusterTitle: provider.title, onHeaderSelection: that._showingSingleFeed ? null : function () {
                                ...
                                contentControl: "CommonJS.News.EntityCluster", contentOptions: {
                                    ...
                                    }, provider: provider, maxColumnCount: that._maxColumnCount, noResultsMessage: "{0} {1}".format(PlatformJS.Services.resourceLoader.getString("NoSourceResultsMessage"), PlatformJS.Services.resourceLoader.getString("NoSourceResultsMessage2")), configKey: "EntityClusterDefaultNewsConfig", configObject: CommonJS.News.EntityClusterConfig.DefaultNews, theme: "newsAppTheme", telemetry: {
