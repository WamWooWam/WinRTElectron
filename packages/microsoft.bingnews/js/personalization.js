...
(function() {
"use strict";
WinJS.Namespace.define("NewsJS.Personalization", {MySourcesDataProvider: WinJS.Class.define(function(options) {
this._init(options)
}, {
...
(function() {
"use strict";
WinJS.Namespace.define("NewsJS.Personalization", {MySourcesControl: WinJS.Class.derive(NewsApp.Controls.ControlBase, function(element, options, orchestrator) {
...
return {element: itemPromise.then(function _cnpRenderer(item) {
...
var provider=this.createProviderInstance();
return {element: itemPromise.then(function _cnpRenderer() {
var div=document.createElement("div");
WinJS.Utilities.addClass(div, "mySourcesItem");
