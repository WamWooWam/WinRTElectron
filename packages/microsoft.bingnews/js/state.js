...
(function () {
    ...
    var StateHandler = WinJS.Class.define(function stateHandlercTor() {
        ...
        }, _isPreviewModeEnabled: false, _stateLayerLoaded: false, hasPulledPdpData: {
            get: function get() {
        ...
        }, allSources: null, _currentMarket: {
            get: function get() {
        ...
        }, _win81RoamedFileBaseName: "bingDailyClusterDefinitions_", _win81Version: 2, _win80RoamedFileBaseName: "clusterDefinitions_", _win80Version: 1.12, _win81clustersDefinitionFileExists: {
            get: function get() {
                return WinJS.Application.roaming.exists(this._win81RoamedFileBaseName + this._currentMarket + ".json")
            }
        }, _win80clustersDefinitionFileExists: {
            get: function get() {
    ...
    var StateTemp = WinJS.Class.define(function statecTor() { }, {
        isPreviewModeEnabled: {
            get: function get() {
