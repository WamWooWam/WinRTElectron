...
(function() {
"use strict";
WinJS.Namespace.define("NewsJS.Controls", {DomUtil: WinJS.Class.mix(WinJS.Class.define(function(domElement, options){}, {}, {domCollapser: WinJS.Binding.converter(function(data) {
return data && data.length > 0 ? "" : "none"
})}), WinJS.UI.DOMEventMixin)})
})();
(function() {
"use strict";
WinJS.Namespace.define("NewsJS.Controls", {MoreColumnControl: WinJS.Class.mix(WinJS.Class.define(function(element, options) {
var that=this;
...
WinJS.Namespace.define("NewsJS", {SlideShowEntryBlock: WinJS.Class.define(function(element, options) {
...
(function() {
"use strict";
WinJS.Namespace.define("NewsJS.Controls", {VerticalScrollContainer: WinJS.Class.derive(CommonJS.Immersive.ItemsContainer, function(element, options) {
