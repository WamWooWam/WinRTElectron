...
WinJS.Namespace.define("NewsJS", {NewsBasePage: WinJS.Class.define(function(state) {
var that=this;
...
(function() {
"use strict";
WinJS.Namespace.define("NewsJS", {BasePartnerPano: WinJS.Class.derive(NewsJS.NewsBasePage, function BasePartnerPano_ctor(state) {
