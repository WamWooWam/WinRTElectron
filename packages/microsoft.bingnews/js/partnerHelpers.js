...
(function() {
"use strict";
WinJS.Namespace.define("NewsJS.Partners", {BaseProcessListener: WinJS.Class.define(function Partner_BaseProcessListener_ctor() {
this._pageMapping = {};
...
_availableMarkets: null, isInAvailableMarket: {get: function get() {
...
}}, _isPartnerApp: null, isPartnerApp: {get: function get() {
...
(function() {
"use strict";
WinJS.Namespace.define("NewsJS.Partners", {NewsClusterProvider: WinJS.Class.define(function(categoryInfo, title, maxArticles, onsuccess, onerror, bypassCache) {
...
(function() {
"use strict";
WinJS.Namespace.define("NewsJS.Partners", {SlideShowPage: WinJS.Class.derive(NewsJS.SlideShowPage, function partner_slideshowpage_ctor(state) {
...
(function() {
"use strict";
WinJS.Namespace.define("NewsJS.Partners", {WhiteLabelProcessListener: WinJS.Class.derive(NewsJS.Partners.BaseProcessListener, function() {
