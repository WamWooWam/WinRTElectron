...
(function() {
"use strict";
WinJS.Namespace.define("NewsJS.Telemetry.ArticleReader", {recordActionClick: function recordActionClick(partnerChannelId) {
if (partnerChannelId) {
...
(function() {
"use strict";
WinJS.Namespace.define("NewsJS.Telemetry.Category", {recordRefreshButtonClick: function recordRefreshButtonClick(e) {
NewsJS.Telemetry.Utilities.recordButtonClick("Refresh Button", Microsoft.Bing.AppEx.Telemetry.ActionContext.appBar, e);
NewsJS.Telemetry.Utilities.recordRefresh(Microsoft.Bing.AppEx.Telemetry.ContentClear.refresh)
}})
})();
...
(function() {
"use strict";
WinJS.Namespace.define("NewsJS.Telemetry.RSSSourcePage", {recordRSSSourceItemPress: function recordRSSSourceItemPress(item) {
if (item) {
...
(function() {
"use strict";
WinJS.Namespace.define("NewsJS.Telemetry.SlideShow", {recordSlideShowToArticle: function recordSlideShowToArticle(slideShowId, market, pageId, contentId) {
