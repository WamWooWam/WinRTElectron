...
(function() {
"use strict";
WinJS.Namespace.define("NewsJS.Tile", {newsSecondaryTile: WinJS.Class.define(function(tileId, tileShortName, tileDisplayName, tileLaunchTargetPage, tileLaunchArgument, tileLogo) {
this._tileId = tileId;
