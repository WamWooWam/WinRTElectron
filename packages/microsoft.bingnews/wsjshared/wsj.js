...
(function () {
    ...
    WinJS.Namespace.define("WSJJS", {
        MarketData: WinJS.Class.define(function (element, options) {
            ...
            other: 0, tileFormat: 1, panoWatermark: 2, articleFormat: 3, _instance: null, instance: {
                get: function get() {
            ...
            currentEdition: "CurrentEdition", _instance: null, instance: {
                get: function get() {
    ...
    WinJS.Namespace.define("WSJJS.NewsCluster", {
        Provider: WinJS.Class.derive(NewsJS.Partners.NewsClusterProvider, function WSJJS_cluster_provider(categoryInfo, title, maxArticles, onsuccess, onerror, bypassCache, isPrimaryCluster) {
    ...
    WinJS.Namespace.define("WSJJS", {
        BasePanoPage: WinJS.Class.derive(NewsJS.BasePartnerPano, function (state) {
    ...
    WinJS.Namespace.define("WSJJS.ArticleReader", {
        WSJArticleActionsHandler: WinJS.Class.define(function () { }, {
    ...
    WinJS.Namespace.define("WSJJS.Ads", {
        AdFormatter: WinJS.Class.derive(PlatformJS.Ads.Partners.AdFormatter, function () {
