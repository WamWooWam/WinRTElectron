...
WinJS.Namespace.define("PlatformJS", {execDeferredNavigate: function execDeferredNavigate(delegate) {
...
}, manifest: {instrumentationMapping: {hasKey: function hasKey() {
return false
...
if (this._running) {
msRequestAnimationFrame(this._delegate)
}
}
...
'use strict';
WinJS.Namespace.define("CommonJS", {ProcessListener: WinJS.Class.define(function processListenerInit() {
