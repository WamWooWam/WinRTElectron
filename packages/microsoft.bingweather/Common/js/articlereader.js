...
WinJS.Namespace.define("CommonJS.ArticleReader", {ArticleReaderUtils: {
...
TextRenderer: {render: function render(renderableBlock, context) {
...
return textBlockElt
}}, GrowlRenderer: {render: function render(renderableBlock, context) {
...
}}, NullRenderer: {render: function render(renderableBlock, context) {
var elt=document.createElement("div");
elt.style.display = "none";
return elt
}}, RectRenderer: {render: function render(renderableBlock, context) {
var block=renderableBlock.block;
var attributes=block.attributes;
...
return rectBlockElt
}}, ImageRenderer: {render: function render(renderableBlock, context) {
...
new CommonJS.ImageAttribution(attributionElt, {flyout: {
...
"use strict";
var ARUtils=CommonJS.ArticleReader.ArticleReaderUtils;
WinJS.Namespace.define("CommonJS.ArticleReader", {TitleStyle1Renderer: {
...
WinJS.Namespace.define("CommonJS.ArticleReader", {TitleStyle2Renderer: {
render: function render(renderableTitle, context) {
var auxiliaryData=context.auxiliaryData;
var cacheId=auxiliaryData.cacheId;
var gridOptions=context.gridOptions;
...
var ARUtils=CommonJS.ArticleReader.ArticleReaderUtils;
var headlineTextClassName="headlineText2";
WinJS.Namespace.define("CommonJS.ArticleReader", {TitleStyle200Renderer: {
render: function render(renderableTitle, context) {
var auxiliaryData=context.auxiliaryData;
var cacheId=auxiliaryData.cacheId;
var gridOptions=context.gridOptions;
...
"use strict";
var ARUtils=CommonJS.ArticleReader.ArticleReaderUtils;
WinJS.Namespace.define("CommonJS.ArticleReader", {TitleStyle9Renderer: {
render: function render(renderableTitle, context) {
var auxiliaryData=context.auxiliaryData;
var cacheId=auxiliaryData.cacheId;
var gridOptions=context.gridOptions;
...
"use strict";
var ARUtils=CommonJS.ArticleReader.ArticleReaderUtils;
WinJS.Namespace.define("CommonJS.ArticleReader", {TitleStyle900Renderer: {
render: function render(renderableTitle, context) {
var auxiliaryData=context.auxiliaryData;
var cacheId=auxiliaryData.cacheId;
var gridOptions=context.gridOptions;
...
"use strict";
WinJS.Namespace.define("CommonJS.ArticleReader", {TitleStyle10Renderer: {
render: function render(renderableTitle, context) {
return null
}, layout: function layout(titleRenderableBlocks, context){}
}})
...
"use strict";
var ARUtils=CommonJS.ArticleReader.ArticleReaderUtils;
WinJS.Namespace.define("CommonJS.ArticleReader", {TitleStyle100Renderer: {
render: function render(renderableTitle, context) {
var auxiliaryData=context.auxiliaryData;
var cacheId=auxiliaryData.cacheId;
var gridOptions=context.gridOptions;
...
var ARUtils=CommonJS.ArticleReader.ArticleReaderUtils;
var CommonUtils=CommonJS.Utils;
WinJS.Namespace.define("CommonJS.ArticleReader", {InlineRendererHelper: {
...
"use strict";
WinJS.Namespace.define("CommonJS.ArticleReader", {InlineImageRenderer: {
...
WinJS.Namespace.define("CommonJS.ArticleReader", {InlineSlideshowRenderer: {
render: function render(renderableBlock, context) {
var block=renderableBlock.block;
var attributes=block.attributes;
var imageAttributes=attributes.image;
...
WinJS.Namespace.define("CommonJS.ArticleReader", {InlineVideoRenderer: {
render: function render(renderableBlock, context) {
var block=renderableBlock.block;
var attributes=block.attributes;
var gridOptions=context.gridOptions;
...
"use strict";
WinJS.Namespace.define("CommonJS.ArticleReader", {ReferralRenderer: {
render: function render(renderableBlock, context) {
var block=renderableBlock.block;
var attributes=block.attributes;
var gridOptions=context.gridOptions;
...
"use strict";
WinJS.Namespace.define("CommonJS.ArticleReader", {ExternalRenderer: {
render: function render(renderableBlock, context) {
var block=renderableBlock.block;
var attributes=block.attributes;
var auxiliaryData=context.auxiliaryData;
...
"use strict";
var U=CommonJS.ArticleReader.ArticleReaderUtils;
WinJS.Namespace.define("CommonJS.ArticleReader", {ActionsRenderer: {
...
var imageCard=new CommonJS.ImageCard(iconElt, {imageSource: {
...
"use strict";
var ARUtils=CommonJS.ArticleReader.ArticleReaderUtils;
WinJS.Namespace.define("CommonJS.ArticleReader", {InlineAdRenderer: {
render: function render(renderableBlock, context) {
var attributes=renderableBlock.block.attributes;
...
return this._elt
}}, isRendered: {get: function get() {
return this._isRendered
}}, articleType: {get: function get() {
return "article"
}}, paywallCard: {
get: function get() {
...
}, isShowingPaywallCard: {get: function get() {
...
var block={
type: "InlineImage", attributes: {image: {
...
var U=CommonJS.ArticleReader.ArticleReaderUtils;
WinJS.Namespace.define("CommonJS.ArticleReader", {ArticleReaderOrchestrator: WinJS.Class.mix(WinJS.Class.define(function _ArticleReaderOrchestrator_45(elt, options) {
...
}}, previousArticleId: {get: function get() {
...
}, isCurrentArticleShowingPaywallCard: {get: function get() {
var article=this._articles[this._currentArticleId];
...
"use strict";
WinJS.Namespace.define("CommonJS.ArticleReader", {TocArticleOrchestrator: WinJS.Class.mix(WinJS.Class.define(function _TocArticleOrchestrator_12(elt, options) {
this._pageWidth = null;
this._pageHeight = null;
this._gridOptions = null;
...
"use strict";
WinJS.Namespace.define("CommonJS.ArticleReader", {TocAnchor: WinJS.Class.mix(WinJS.Class.define(function _TocAnchor_13(elt, options) {
var that=this;
this.elt = elt;
elt.winControl = this;
CommonJS.Utils.markDisposable(elt);
...
"use strict";
WinJS.Namespace.define("CommonJS.ArticleReader", {SmoothScrollOrchestrator: WinJS.Class.derive(CommonJS.ArticleReader.ArticleReaderOrchestrator, function _SmoothScrollOrchestrator_13(elt, options) {
...
"use strict";
var U=CommonJS.ArticleReader.ArticleReaderUtils;
WinJS.Namespace.define("CommonJS.ArticleReader", {PartialPageSpacerRenderer: {
...
WinJS.Namespace.define("CommonJS.ArticleReader", {PartialPageOrchestrator: WinJS.Class.derive(BaseOrchestrator, function partialpageorchestrator_ctor(elt, options) {
...
msRequestAnimationFrame(this._transitionColumnsStyle.bind(this, scrollLeft, offset, transitionTimeInMills, new Date))
}
}
}, _onScroll: function _onScroll(event) {
if (!this._suspendScrollHandler) {
...
msRequestAnimationFrame(this._transitionColumnsStyle.bind(this, scrollLeft, totalDistance, totalTime, startTime))
}
...
WinJS.Namespace.define("CommonJS.ArticleReader", {Toc: WinJS.Class.mix(WinJS.Class.define(function _Toc_15(elt, options) {
var that=this;
...
"use strict";
var U=CommonJS.ArticleReader.ArticleReaderUtils;
WinJS.Namespace.define("CommonJS.ArticleReader", {ArticleReaderPaginatedViewManager: WinJS.Class.derive(CommonJS.PaginatedViewManager, function _ArticleReaderPaginatedViewManager_16(options) {
...
"use strict";
WinJS.Namespace.define("CommonJS.ArticleReader", {ArticlePlaceholder: WinJS.Class.define(function _ArticlePlaceholder_13(elt, options) {
elt = this._elt = elt || document.createElement("div");
elt.winControl = this;
CommonJS.Utils.markDisposable(elt);
WinJS.Utilities.addClass(elt, "placeholder")
}, {
_elt: null, element: {get: function get() {
return this._elt
}}, dispose: function dispose(){}
}, {})})
})();
...
WinJS.Namespace.define("CommonJS", {ArticleReaderPage: WinJS.Class.define(function articleReaderPage_ctor(state) {
this._state = state;
...
"use strict";
WinJS.Namespace.define("CommonJS", {WebViewArticleReaderPage: WinJS.Class.derive(CommonJS.ArticleReaderPage, function _WebViewArticleReaderPage_6(state) {
...
"use strict";
WinJS.Namespace.define("CommonJS.ArticleReader", {ArticleStore: WinJS.Class.define(function _ArticleStore_12() {
this._dataMap = {}
}, {
...
"use strict";
WinJS.Namespace.define("CommonJS.ArticleReader", {ArticleManager: WinJS.Class.mix(WinJS.Class.define(function _ArticleManager_14(options) {
...
}, cacheId: {set: function set(value) {
this._cacheId = value
}}, currentArticleId: {get: function get() {
...
WinJS.Namespace.define("CommonJS.ArticleReader", {ContentFrameManager: WinJS.Class.define(function _ContentFrameManager_29(options) {
...
(function _Footer_7() {
"use strict";
WinJS.Namespace.define("CommonJS.ArticleReader", {Footer: WinJS.Class.define(function _Footer_13(elt, options) {
elt = this.elt = elt ? elt : document.createElement("div");
elt.winControl = this;
...
_pageNumber: null, _pageNumberContainerElt: null, pageNumberString: {set: function set(value) {
var pageNumber=this._pageNumber;
if (pageNumber) {
pageNumber.pageNumberString = value
}
}}, pageNumberVisible: {set: function set(value) {
...
"use strict";
WinJS.Namespace.define("CommonJS.ArticleReader", {HeaderStyle1Renderer: {
...
"use strict";
var ARUtils=CommonJS.ArticleReader.ArticleReaderUtils;
WinJS.Namespace.define("CommonJS.ArticleReader", {HeaderStyle2Renderer: {
...
(function _Header_7() {
"use strict";
WinJS.Namespace.define("CommonJS.ArticleReader", {Header: WinJS.Class.define(function _Header_12(elt, options) {
elt = this.elt = elt ? elt : document.createElement("div");
elt.winControl = this;
elt.innerHTML = "";
...
_context: null, _pageNumber: null, _renderer: null, pageNumberString: {set: function set(value) {
var pageNumber=this._pageNumber;
if (pageNumber) {
pageNumber.pageNumberString = value
}
...
"use strict";
WinJS.Namespace.define("CommonJS.ArticleReader", {HeaderFactory: WinJS.Class.define(function _HeaderFactory_12(){}, {}, {getRenderer: function getRenderer(style) {
var headerRenderer;
switch (style) {
case 1:
...
"use strict";
WinJS.Namespace.define("CommonJS.ArticleReader", {GridCalculator: WinJS.Class.define(function _GridCalculator_13(){}, {}, {
...
"use strict";
WinJS.Namespace.define("CommonJS.ArticleReader", {FontCalculator: WinJS.Class.define(function _FontCalculator_13(){}, {}, {
...
"use strict";
WinJS.Namespace.define("CommonJS.ArticleReader", {PageManager: WinJS.Class.define(function _PageManager_13(options) {
...
_surfaceManager: null, _contentElements: null, _headerElements: null, _footerElements: null, _pageIndex: null, _header: null, _footer: null, pageIndex: {get: function get() {
return this._pageIndex
}}, pageNumberVisible: {set: function set(value) {
if (this._footer) {
this._footer.pageNumberVisible = value
}
}}, pageNumberString: {set: function set(value) {
...
"use strict";
WinJS.Namespace.define("CommonJS.ArticleReader", {PageNumber: WinJS.Class.define(function _PageNumber_13(elt, options) {
...
_elt: null, pageNumberString: {set: function set(value) {
var elt=this._elt;
elt.innerText = value
}}
}, {})})
...
WinJS.Namespace.define("CommonJS.ArticleReader", {SurfaceManager: WinJS.Class.define(function surfacemanager_ctor(options) {
...
"use strict";
WinJS.Namespace.define("CommonJS.ArticleReader", {AdContainer: WinJS.Class.define(function _AdContainer_13(elt, options) {
elt = this._elt = elt ? elt : document.createElement("div");
elt.winControl = this;
CommonJS.Utils.markDisposable(elt);
...
_elt: null, _adControl: null, _controlOptions: null, _controlType: null, _isAdInstantiated: null, element: {get: function get() {
return this._elt
...
"use strict";
WinJS.Namespace.define("CommonJS.ArticleReader", {InterstitialAd: WinJS.Class.mix(WinJS.Class.define(function _InterstitialAd_14(elt, options) {
elt = this._elt = elt || document.createElement("div");
elt.winControl = this;
CommonJS.Utils.markDisposable(elt);
...
this._isRendered = false;
this._gridOptions = null;
this._instrumentationData = {content: {
...
_elt: null, _adContainer: null, _isRendered: null, _instrumentationData: null, _gridOptions: null, element: {get: function get() {
return this._elt
}}, isRendered: {get: function get() {
return this._isRendered
}}, articleType: {get: function get() {
...
"use strict";
WinJS.Namespace.define("CommonJS.ArticleReader", {ArticleReaderWebView: WinJS.Class.derive(CommonJS.UI.WebView, function articleReaderWebViewCtor(elt, options) {
...
_instrumentationData: null, _header: null, isRendered: {get: function get() {
return this._isRendered
}}, articleType: {get: function get() {
return "webpage"
}}, getHeader: function getHeader() {
...
"use strict";
WinJS.Namespace.define("CommonJS.ArticleReader", {DisposalManager: WinJS.Class.mix(WinJS.Class.define(function _DisposalManager_13(options) {
...
WinJS.Namespace.define("CommonJS.ArticleReader", {DebugUtils: WinJS.Class.define(function DebugUtils_ctor(){}, {}, {
...
WinJS.Namespace.define("CommonJS.ArticleReader", {ActionsHandler: WinJS.Class.define(function _ActionsHandler_13(){}, {onActionInvoked: function onActionInvoked(event) {
var data=event.data;
launchUriAction(data.actionOptions, data.impressionNavMethod, false)
}})});
WinJS.Namespace.define("CommonJS.ArticleReader", {ExternalActionsHandler: WinJS.Class.define(function ActionsHandlerCtor(){}, {onActionInvoked: function onActionInvoked(event) {
var data=event.data;
