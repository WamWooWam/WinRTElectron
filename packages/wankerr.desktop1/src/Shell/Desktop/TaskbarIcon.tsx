...
export class TaskbarIconComponent extends Component<TaskbarIcon, TaskbarIconState> {
    render(props: TaskbarIcon, state: TaskbarIconState) {
        ...
        return (
            <button className={className} onClick={props.activated} onMouseEnter={this.onMouseEnter.bind(this)} onMouseMove={this.onMouseMove.bind(this)} onMouseLeave={this.onMouseLeave.bind(this)}>
