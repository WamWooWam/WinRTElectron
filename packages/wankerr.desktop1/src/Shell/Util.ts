...
export function createSplashElement(app: PackageApplication) {
    let splash = document.createElement("div");
    splash.classList.add("splashScreen");
    splash.style.cssText = `background: ${app.visualElements.splashScreen.backgroundColor ?? app.visualElements.backgroundColor};`;
    ...
    splashScreenImage.classList.add("splashScreenImage");
