...
(function (WinJS, undefined) {
    ...
    WinJS.Namespace.define("MicrosoftNSJS.Advertising", {
        ...
        AdPackage: WinJS.Class.define(function (applicationId, adUnitId) {
        ...
        },
        {
            ...
            refresh: function () {
                ...
                if ((typeof (this.applicationId) === 'undefined' || this.applicationId === null)
                    ||
                    (typeof (this.adUnitId) === 'undefined' || this.adUnitId === null)) {
            ...
            reportEvent: function (eventType) {
                try {
                    ...
                    if (this.fullAdPayload.VAST.Ad.length > 0) {
                        if (eventType === MicrosoftNSJS.Advertising.AdPackage.eventType.AdImpression &&
                            this._impressionUrls.length > 0) {
                            
                            return this._placement.reportClientEvents(this._impressionUrls);
                        }
                        else if (eventType === MicrosoftNSJS.Advertising.AdPackage.eventType.AdError &&
                            this._errorEventUrl != null) {
                            
                            return this._placement.reportClientEvents(new Array(this._errorEventUrl));
                        }
                        else if (eventType === MicrosoftNSJS.Advertising.AdPackage.eventType.AdClickThru &&
                            this._videoClickThroughTrackingUrls.length > 0) {
            ...
            _loadData: function () {
                ...
                if (typeof (this.fullAdPayload) === 'object' &&
                    typeof (this.fullAdPayload.VAST) === 'object' &&
                    typeof (this.fullAdPayload.VAST.Ad) === 'object' &&
                    this.fullAdPayload.VAST.Ad.length > 0 &&
                    typeof (this.fullAdPayload.VAST.Ad[0].InLine) === 'object') {
                    ...
                    for (var i = 0; i < creatives.length; i++) {
                        if (this.linearCreative === null && creatives[i].type === 'linear') {
                            ...
                            if (this.linearCreative.TrackingEvents !== null &&
                                typeof (this.linearCreative.TrackingEvents) === 'object') {
                                this._trackingEventUrls = this.linearCreative.TrackingEvents;
                            }

                            if (this.linearCreative.VideoClicks !== null &&
                                typeof (this.linearCreative.VideoClicks) === 'object' &&
                                this.linearCreative.VideoClicks.ClickTracking !== null &&
                                typeof (this.linearCreative.VideoClicks.ClickTracking) === 'object' &&
                                this.linearCreative.VideoClicks.ClickTracking.length > 0) {
        ...
        },
        {
            ...
            eventType: {
                ...
                "AdExpand": "expand",
                "AdCollapse": "collapse",
                "AdAcceptInvitation": "acceptinvitation",
                "AdClose": "close"
            },
