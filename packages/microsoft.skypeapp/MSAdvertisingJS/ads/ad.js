    ...
    WinJS.Namespace.define("MicrosoftNSJS.Advertising", {
        ...
        AdControl: WinJS.Class.define(function (element, options) {
            ...
            try {
                ...
                this._onAdRenderedInternal = null;
            ...
            _RESERVED_CLOSE_BAND_HEIGHT: 2 * 50, 

            _MIN_AD_REFRESH_INTERVAL_IN_MILLISECONDS_METERED: 60000, 
            _MIN_AD_REFRESH_INTERVAL_IN_MILLISECONDS_UNMETERED: 30000, 
            ...
            onAdRendered: {
                get: function () { return this._onAdRendered; },
                set: function (value) {
                    if (typeof (value) === "function" || value === null || typeof (value) === "undefined") {
            ...
            _networkChangedEventHandler: function () {  },
            ...
            _onAdReceived: function (ad) {
                if (typeof (ad) !== "undefined" && ad !== null) {
                    ...
                    var createFrameAndLoadAd = function () {
                        ...
                        self._onAdRenderedInternal = function () {
                            ...
                            self._onAdRenderedInternal = null;
                        };
            ...
            _createIFrame: function (frameId, width, height, parentElem, ormmaState) {
                try {
					...
					var extraParam = "";
					if (this.isSkypeAd) {
						extraParam = "&isSkypeAd=1";
					}
					iframe.src = "ms-appx-web:///MSAdvertisingJS/ads/bootstrap.html?bubblePointerEvents=1" + extraParam;
                    ...
                    var first = parentElem.firstChild;
                    parentElem.insertBefore(iframe, first);
            ...
            _fireAdRendered: function () {
                if (typeof (this._onAdRenderedInternal) === "function") {
                    this._onAdRenderedInternal();
                }
