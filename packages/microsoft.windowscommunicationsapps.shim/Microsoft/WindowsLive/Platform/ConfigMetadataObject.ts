...
@GenerateShim('Microsoft.WindowsLive.Platform.ConfigMetadataObject')
export class ConfigMetadataObject implements IConfigMetadataObject, IObject { 
    ...
    commit(): void {
        console.warn('ConfigMetadataObject#commit not implemented')
    }
    deleteObject(): void {
        console.warn('ConfigMetadataObject#deleteObject not implemented')
    }
    getKeepAlive(): ITransientObjectHolder {
        throw new Error('ConfigMetadataObject#getKeepAlive not implemented')
    }
