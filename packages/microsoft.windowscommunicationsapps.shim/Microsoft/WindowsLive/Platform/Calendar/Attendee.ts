...
@GenerateShim('Microsoft.WindowsLive.Platform.Calendar.Attendee')
export class Attendee implements IObject, IDisposable, IAttendee { 
    ...
    commit(): void {
        console.warn('Attendee#commit not implemented')
    }
    deleteObject(): void {
        console.warn('Attendee#deleteObject not implemented')
    }
    getKeepAlive(): ITransientObjectHolder {
        throw new Error('Attendee#getKeepAlive not implemented')
    }
    dispose(): void {
        console.warn('Attendee#dispose not implemented')
    }
