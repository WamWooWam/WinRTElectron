...
@GenerateShim('Microsoft.WindowsLive.Platform.MailRule')
export class MailRule implements IMailRule, IObject { 
    ...
    runMailRule(strScopeFolderId: string): void {
        console.warn('MailRule#runMailRule not implemented')
    }
    commit(): void {
        console.warn('MailRule#commit not implemented')
    }
    deleteObject(): void {
        console.warn('MailRule#deleteObject not implemented')
    }
    getKeepAlive(): ITransientObjectHolder {
        throw new Error('MailRule#getKeepAlive not implemented')
    }
