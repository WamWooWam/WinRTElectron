...
@GenerateShim('Microsoft.WindowsLive.Platform.AccountToken')
export class AccountToken implements IAccountToken, IObject { 
    ...
    commit(): void {
        console.warn('AccountToken#commit not implemented')
    }
    deleteObject(): void {
        console.warn('AccountToken#deleteObject not implemented')
    }
    getKeepAlive(): ITransientObjectHolder {
        throw new Error('AccountToken#getKeepAlive not implemented')
    }
