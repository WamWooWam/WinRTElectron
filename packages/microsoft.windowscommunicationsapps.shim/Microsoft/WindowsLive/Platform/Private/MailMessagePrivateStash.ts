...
@GenerateShim('Microsoft.WindowsLive.Platform.Private.MailMessagePrivateStash')
export class MailMessagePrivateStash implements IObject { 
    ...
    commit(): void {
        console.warn('MailMessagePrivateStash#commit not implemented')
    }
    deleteObject(): void {
        console.warn('MailMessagePrivateStash#deleteObject not implemented')
    }
    getKeepAlive(): ITransientObjectHolder {
        throw new Error('MailMessagePrivateStash#getKeepAlive not implemented')
    }
