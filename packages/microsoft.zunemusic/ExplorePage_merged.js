...
(function() {
    ...
    (function() {
        ...
        WinJS.Namespace.defineWithParent(MSE.Data, "Query", {
            SpotlightQueryType: {
                SpotlightMusic: "spotlight",
                SpotlightVideo: "spotlight"
            },
            recommendationBrowseFields: [MS.Entertainment.Data.Query.edsFields.allTimeAverageRating, MS.Entertainment.Data.Query.edsFields.explanations, MS.Entertainment.Data.Query.edsFields.id, MS.Entertainment.Data.Query.edsFields.images, MS.Entertainment.Data.Query.edsFields.mediaGroup, MS.Entertainment.Data.Query.edsFields.mediaItemType, MS.Entertainment.Data.Query.edsFields.name, MS.Entertainment.Data.Query.edsFields.vuiDisplayName, MS.Entertainment.Data.Query.edsFields.zuneId],
            createEditorialHeaders: function createEditorialHeaders() {
                ...
                var spotlightHeaders = {
                    "User-Agent": configurationManager.service.targetedProgrammingClientOs,
                    "X-Application": MS.Entertainment.Utilities.isVideoApp ? "Video" : "Music",
                    "X-Membership-Level": configurationManager.service.lastSignedInUserMembership || "Free",
                    "X-Parent-Control": configurationManager.service.lastSignedInUserParentControl.toString(),
                    "X-Client-Version": configurationManager.service.targetedProgrammingClientVersion,
                    "X-Client-Architecture": mappedArchitecture
                };
        ...
        WinJS.Namespace.defineWithParent(MSE.Data, "Query", {
            spotlightContentQuery: MSE.derive(MSE.Data.ServiceWrapperQuery, null, {
                spotlight: String.empty,
                ...
                createParameters: function createParameters() {
                    ...
                    if (configurationManager.service.enableTimeTravel)
                        return {
                            StartDate: configurationManager.service.timeTravelStartDate
                        };
                    else
                        return null
                },
                ...
                pluralizers: ["Content/SlotGroup", "SlotGroup/Slot"],
                resultAugmentation: MSE.Data.Augmenter.Spotlight.SpotlightContent
            })
        });
        WinJS.Namespace.defineWithParent(MSE.Data, "Query", {
            MusicMediaDiscoverySpotlightQuery: MSE.derive(MSE.Data.Query.spotlightContentQuery, null, {
                serviceType: MS.Entertainment.Data.ServiceWrapperQuery.ServiceTypes.json,
                spotlight: MSE.Data.Query.SpotlightQueryType.SpotlightMusic,
                getResourceEndpointID: function getResourceEndpointID() {
        ...
        WinJS.Namespace.defineWithParent(MSE.Data, "Query", {
            videoSpotlightQuery: MSE.derive(MSE.Data.Query.spotlightContentQuery, null, {
                spotlight: MSE.Data.Query.SpotlightQueryType.SpotlightVideo,
                getResourceEndpointID: function getResourceEndpointID() {
                    return MS.Entertainment.Endpoint.id.seid_MediaDiscovery
                },
                ...
                pluralizers: [MSE.Data.Query.marketplaceWrapperQuery.slotGroupPluralizer, MSE.Data.Query.marketplaceWrapperQuery.slotPluralizer],
                resultAugmentation: MSE.Data.Augmenter.Spotlight.VideoSpotlightContent
            })
        });
        var xuidTokenTable = {};
        WinJS.Namespace.defineWithParent(MSE.Data, "Query", {
            EdsVideoRecommendations: MSE.derive(MSE.Data.Query.EDSDeviceQuery, null, {
                chunkSize: 20,
                requestFields: MS.Entertainment.Data.Query.recommendationBrowseFields,
                useApp2UserIfAvailable: true,
                includeContentRestrictionHeader: true,
                enabledImpressionGuid: true,
                queryType: "videoRecommendations",
                createResourceURI: function() {
                    ...
                    if (MS.Entertainment.Utilities.isVideoApp2) {
                        ...
                        uri = MS.Entertainment.Utilities.UriFactory.appendQuery(uri, {
                            random: xuidTokenTable[currentUserXuid] + contentRestrictionSuffixString
                        })
                    }
                    return uri
                },
                createParameters: function createParameters() {
                    ...
                    return {
                        desiredMediaItemTypes: typeArray,
                        firstPartyOnly: true
                    }
                },
                resultAugmentation: MSE.Data.Augmenter.Marketplace.EdsRecommendedVideoList,
                useCache: false
            })
        });
        WinJS.Namespace.defineWithParent(MSE.Data, "Query", {
            MusicUpdatePanel: MSE.deferredDerive(MS.Entertainment.Data.ServiceWrapperQuery, null, {
                chunked: false,
                resultAugmentation: MS.Entertainment.Data.Augmenter.Marketplace.IntroPanelResult,
                createResourceURI: function() {
                ...
                (function(Controls) {
                    ...
                    var Carousel = (function(_super) {
                        ...
                        function Carousel(element, options) {
                            ...
                            this._pageChangedHandler = MS.Entertainment.Utilities.addEventHandlers(this.domElement, {
                        ...
                        Carousel.prototype._dataSourceChanged = function() {
                            ...
                            if (this.dataSource) {
                                ...
                                this._firstTimeRenderHandlers = UI.Framework.addEventHandlers(this.domElement, {
                                    pagevisibilitychanged: function() {
                ...
                var HeroModule = (function(_super) {
                    ...
                    HeroModule.prototype.getItems = function() {
                        ...
                        this._getItemsPromise = query.execute().then(function(queryResult) {
                            ...
                            return {
                                items: resultItems.map(_this._wrapItem)
                            }
                        });
                        return this._getItemsPromise
                    };
                    ...
                    HeroModule.prototype._wrapItem = function(spotlightItem) {
                        ...
                        if (spotlightItem.type)
                            switch (spotlightItem.type) {
                                case MS.Entertainment.Data.Augmenter.Spotlight.ActionType.Web:
                                    ...
                                    actionParameter = {
                                        link: spotlightItem.actionTarget
                                    };
                                    break;
                                case MS.Entertainment.Data.Augmenter.Spotlight.MediaType.Album:
                                    ...
                                    actionParameter = {
                                        data: mediaItem,
                                        location: MS.Entertainment.Data.ItemLocation.marketplace,
                                        isFromSpotlight: true
                                    };
                                    break;
                        ...
                        return {
                            ...
                            mediaItem: mediaItem,
                            imageUri: spotlightItem.imagePrimaryUrl,
                            imageResizeUri: spotlightItem.imagePrimaryUrl,
                            imagePrimaryUrl: spotlightItem.imagePrimaryUrl,
                            primaryText: spotlightItem.primaryText,
                            secondaryText: spotlightItem.secondaryText,
...
(function() {
    ...
    (function(undefined) {
        ...
        WinJS.Namespace.define("MS.Entertainment.UI.Actions", {
            externalNavigateAction: MS.Entertainment.deferredDerive("MS.Entertainment.UI.Actions.Action", function externalNavigateActionConstructor() {
                this.base();
        ...
        WinJS.Namespace.define("MS.Entertainment.UI.Actions", {
            externalAdNavigateAction: MS.Entertainment.deferredDerive("MS.Entertainment.UI.Actions.externalNavigateAction", function externalAdNavigateActionConstructor() {
                this.base()
            }, {
                executed: function executed(param) {
                    var link = this._extractLink(param);
...
(function() {
    ...
    (function() {
        ...
        WinJS.Namespace.define("MS.Entertainment.UI", {
            Monikers: {
                actorDetailsPage: "actorDetailsPage",
                albumDetails: "albumDetails",
                albumMusicVideos: "albumMusicVideos",
                albumMusicVideosMarketplace: "albumMusicVideosMarketplace",
                allVideoCollection: "allVideoCollection",
                allVideoCollectionPanel: "allVideoCollectionPanel",
                artistAlbums: "artistAlbums",
                artistAlbumsCollection: "artistAlbumsCollection",
                artistAlbumsMarketplace: "artistAlbumsMarketplace",
                artistMusicVideos: "artistMusicVideos",
                artistMusicVideosMarketplace: "artistMusicVideosMarketplace",
                artistSearchAction: "artistSearchAction",
                artistSearchActionPivot: "artistSearchActionPivot",
                browseByActor: "browseByActor",
                browseByActorHub: "browseByActorHub",
                browseMoviesByActor: "browseMoviesByActor",
                browseTVSeriesByActor: "browseTVSeriesByActor",
                companionFeatured: "companionFeatured",
                companionFeaturedGamesPanel: "companionFeaturedGamesPanel",
                companionFeaturedMusicPanel: "companionFeaturedMusicPanel",
                companionFeaturedMoviesPanel: "companionFeaturedMoviesPanel",
                companionFeaturedTVPanel: "companionFeaturedTVPanel",
                companionNowPlaying: "companionNowPlaying",
                companionNowPlayingPanel: "companionNowPlayingPanel",
                companionQuickplay: "companionQuickplay",
                companionQuickplayPanel: "companionQuickplayPanel",
                companionSearch: "companionSearch",
                companionSearchPanel: "companionSearchPanel",
                dashboard: "dashboard",
                fullScreenNowPlaying: "fullScreenNowPlaying",
                homeHub: "homeHub",
                homeSpotlight: "homeSpotlight",
                filteredMovieMarketplace: "filteredMovieMarketplace",
                filteredTvMarketplace: "filteredTvMarketplace",
                filteredMovieMarketplaceSingleStudio: "filteredMovieMarketplaceSingleStudio",
                filteredMovieMarketplaceSingleStudioPanel: "filteredMovieMarketplaceSingleStudioPanel",
                filteredTvMarketplaceSingleNetwork: "filteredTvMarketplaceSingleNetwork",
                filteredTvMarketplaceSingleNetworkPanel: "filteredTvMarketplaceSingleNetworkPanel",
                flexHubPage: "flexHubPage",
                flexHub: "flexHub",
                flexHubPanel: "flexHubPanel",
                featuredSetsPage: "featuredSetsPage",
                featuredSets: "featuredSets",
                featuredSetsPanel: "featuredSetsPanel",
                immersiveDetails: "immersiveDetails",
                albumsSearch: "albumsSearch",
                allMusicSearch: "allMusicSearch",
                allVideoSearch: "allVideoSearch",
                allVideoSearchPanel: "allVideoSearchPanel",
                artistsSearch: "artistsSearch",
                searchPage: "searchPage",
                playlistsSearch: "playlistsSearch",
                playlistDetails: "playlistDetails",
                tracksSearch: "tracksSearch",
                musicVideosSearch: "musicVideosSearch",
                movieCollection: "movieCollection",
                movieCollectionPanel: "movieCollectionPanel",
                movieDetailsPage: "movieDetailsPage",
                movieMarketplace: "movieMarketplace",
                movieMarketplaceFeatured: "movieMarketplaceFeatured",
                movieMarketplaceFeaturedPanel: "movieMarketplaceFeaturedPanel",
                movieMarketplaceNewReleases: "movieMarketplaceNewReleases",
                movieMarketplaceNewReleasesPanel: "movieMarketplaceNewReleasesPanel",
                movieMarketplaceTopPurchased: "movieMarketplaceTopPurchased",
                movieMarketplaceTopPurchasedPanel: "movieMarketplaceTopPurchasedPanel",
                movieMarketplaceTopRented: "movieMarketplaceTopRented",
                movieMarketplaceTopRentedPanel: "movieMarketplaceTopRentedPanel",
                movieMarketplaceTopRated: "movieMarketplaceTopRated",
                movieMarketplaceTopRatedPanel: "movieMarketplaceTopRatedPanel",
                movieMarketplaceHub: "movieMarketplaceHub",
                movieMarketplacePanel: "movieMarketplacePanel",
                movieMarketplacePanel2: "movieMarketplacePanel2",
                movieRecommendations: "movieRecommendations",
                movieRecommendationsPanel: "movieRecommendationsPanel",
                movieSpotlight: "movieSpotlight",
                studioAndNetworkGallery: "studioAndNetworkGallery",
                movieStudioGalleryHub: "movieStudioGalleryHub",
                movieStudioGalleryHubPanel: "movieStudioGalleryHubPanel",
                movieTrailerBrowse: "movieTrailerBrowse",
                musicHub: "musicHub",
                musicCollection: "musicCollection",
                musicCollectionHub: "musicCollectionHub",
                musicCollectionPanel: "musicCollectionPanel",
                musicPlaylistCollection: "musicPlaylistCollection",
                musicMarketplace: "musicMarketplace",
                musicMarketplaceAlbums: "musicMarketplaceAlbums",
                musicMarketplaceAlbumsPanel: "musicMarketplaceAlbumsPanel",
                musicMarketplaceArtists: "musicMarketplaceArtists",
                musicMarketplaceArtistsPanel: "musicMarketplaceArtistsPanel",
                musicMarketplaceFeatured: "musicMarketplaceFeatured",
                musicMarketplaceFeaturedPanel: "musicMarketplaceFeaturedPanel",
                musicMarketplaceGenres: "musicMarketplaceGenres",
                musicMarketplaceGenresPanel: "musicMarketplaceGenresPanel",
                musicMarketplaceHub: "musicMarketplaceHub",
                musicMarketplacePanel: "musicMarketplacePanel",
                musicCollectionByAlbum: "musicCollectionByAlbum",
                musicCollectionByAlbumPanel: "musicCollectionByAlbumPanel",
                musicCollectionByArtist: "musicCollectionByArtist",
                musicCollectionByArtistPanel: "musicCollectionByArtistPanel",
                musicCollectionSmartDJs: "musicCollectionSmartDJs",
                musicCollectionSmartDJsPivot: "musicCollectionSmartDJsPivot",
                musicCollectionBySong: "musicCollectionBySong",
                musicCollectionBySongPanel: "musicCollectionBySongPanel",
                musicCollectionPlaylists: "musicCollectionPlaylists",
                musicCollectionPlaylistsPanel: "musicCollectionPlaylistsPanel",
                musicCollectionNewlyAdded: "musicCollectionNewlyAdded",
                musicCollectionMusicVideos: "musicCollectionMusicVideos",
                musicExploreHub: "musicExploreHub",
                musicNewReleases: "musicNewReleases",
                musicNewReleasesPanel: "musicNewReleasesPanel",
                musicNewReleasesGallery: "musicNewReleasesGallery",
                musicNewVideosGallery: "musicNewVideosGallery",
                musicPopularGallery: "musicPopularGallery",
                musicRecentsPanel: "musicRecentsPanel",
                musicSmartDJs: "musicSmartDJs",
                musicSmartDJsPanel: "musicSmartDJsPanel",
                musicTopMusic: "musicTopMusic",
                musicTopArtistsPanel: "musicTopArtistsPanel",
                musicTopAlbumsPanel: "musicTopAlbumsPanel",
                musicTopVideosPanel: "musicTopVideosPanel",
                musicVideoCollection: "musicVideoCollection",
                musicVideoCollectionPanel: "musicVideoCollectionPanel",
                navigationPopover: "navigationPopover",
                otherVideoCollection: "otherVideoCollection",
                otherVideoCollectionPanel: "otherVideoCollectionPanel",
                playToSpinner: "playToSpinner",
                playToLandingPage: "playToLandingPage",
                ...
                selectPlaylistPivot: "selectPlaylistPivot",
                tempMusicPanel: "tempMusicPanel",
                tempSocialPanel: "tempSocialPanel",
                tempVideoPanel: "tempVideoPanel",
                tvCollection: "tvCollection",
                tvCollectionPanel: "tvCollectionPanel",
                tvDetailsPage: "tvDetailsPage",
                tvMarketplace: "tvMarketplace",
                tvMarketplaceFeatured: "tvMarketplaceFeatured",
                tvMarketplaceFeaturedPanel: "tvMarketplaceFeaturedPanel",
                tvMarketplaceNewReleases: "tvMarketplaceNewReleases",
                tvMarketplaceNewReleasesPanel: "tvMarketplaceNewReleasesPanel",
                tvMarketplaceLastNight: "tvMarketplaceLastNight",
                tvMarketplaceLastNightPanel: "tvMarketplaceLastNightPanel",
                tvMarketplaceTopPurchased: "tvMarketplaceTopPurchased",
                tvMarketplaceTopPurchasedPanel: "tvMarketplaceTopPurchasedPanel",
                tvMarketplaceTopRated: "tvMarketplaceTopRated",
                tvMarketplaceTopRatedPanel: "tvMarketplaceTopRatedPanel",
                tvMarketplaceGenres: "tvMarketplaceGenres",
                tvMarketplaceGenresPanel: "tvMarketplaceGenresPanel",
                tvMarketplaceHub: "tvMarketplaceHub",
                tvMarketplaceNetworks: "tvMarketplaceNetworks",
                tvMarketplaceNetworksPanel: "tvMarketplaceNetworksPanel",
                tvMarketplacePanel: "tvMarketplacePanel",
                tvMarketplacePanel2: "tvMarketplacePanel2",
                tvNetworkGallery: "tvNetworkGallery",
                tvNetworkGalleryHub: "tvNetworkGalleryHub",
                tvNetworkGalleryHubPanel: "tvNetworkGalleryHubPanel",
                tvRecommendations: "tvRecommendations",
                tvRecommendationsPanel: "tvRecommendationsPanel",
                tvSpotlight: "tvSpotlight",
                videoHub: "videoHub",
                videoHubIsolated: "videoHubIsolated",
                videoCollection: "videoCollection",
                videoCollectionHub: "videoCollectionHub",
                videoCollectionPanel: "videoCollectionPanel",
                videoMarketplace: "videoMarketplace",
                videoMovieCollectionPanel: "videoMovieCollectionPanel",
                videoOtherCollectionPanel: "videoOtherCollectionPanel",
                videoTvCollectionPanel: "videoTvCollectionPanel",
                videoWatchlist: "videoWatchlist",
                videoWatchlistPage: "videoWatchlistPage",
                videoWatchlistPanel: "videoWatchlistPanel",
                movieStorePage: "movieStorePage",
                tvStorePage: "tvStorePage",
                welcomeHub: "welcomeHub",
            ...
            (function(ViewModels) {
                ...
                var PlaybackPrivilegesNotifierService = (function() {
                    ...
                    PlaybackPrivilegesNotifierService.prototype._delayInitialize = function() {
                        ...
                        this._signInUserHandlers = MS.Entertainment.Utilities.addEventHandlers(signedInUser, {
                            hasExplicitPrivilegeChanged: function() {
                                return _this._handleHasExplicitPrivilegeChanged()
                            }
                        });
                        this._signInHandlers = MS.Entertainment.Utilities.addEventHandlers(signIn, {
                    ...
                    PlaybackPrivilegesNotifierService.prototype._handleHasExplicitPrivilegeChanged = function() {
                        ...
                        if (signedInUser.hasExplicitPrivilege || !signIn.isSignedIn)
                            ...
                            var notification = listNotificationService.createAndSend(UI.NotificationCategoryEnum.explicitPrivileges, String.load(String.id.IDS_MUSIC_EXPLORE_CHILD_EXPLICIT_BANNER_NOTIFICATION_TITLE), String.empty, [UI.Actions.ActionIdentifiers.externalNavigate], [{
                                parameter: {
                                    link: MS.Entertainment.Endpoint.load(MS.Entertainment.Endpoint.id.seid_XBoxLiveSSL) + "/Account/Settings",
                                    automationId: UI.AutomationIds.settingsAccountPrivacy
                                },
