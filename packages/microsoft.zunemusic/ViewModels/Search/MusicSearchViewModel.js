...
(function (undefined) {
    ...
    WinJS.Namespace.define("MS.Entertainment.ViewModels", {
        MusicSearchAutomationIds: {
            searchAllMusic: "searchAllMusic_modifier", searchCollection: "searchCollection_modifier"
        }
    });
    WinJS.Namespace.define("MS.Entertainment.ViewModels", {
        MusicSearchViewModel: MS.Entertainment.UI.Framework.derive("MS.Entertainment.ViewModels.NewSearchViewModel", function musicSearchViewModelConstructor(searchType, marketplaceEnabled, updateTitleOnFailureOnly) {
            ...
            _musicMarketplaceEnabled: false, _modifiers: null, canSwitchToAllMusicView: {
                get: function get_canSwitchToAllMusicView() {
                    return this._searchType !== MS.Entertainment.ViewModels.MusicSearchViewModel.ViewTypes.allMusic && this._keepPivotOnEmpty
                }
            }, isCollectionView: {
                get: function get_isCollectionView() {
            ...
            }, isAllMusicSearchEnabled: {
                get: function get_isAllMusicSearchEnabled() {
