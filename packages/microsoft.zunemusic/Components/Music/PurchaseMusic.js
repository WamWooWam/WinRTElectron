...
(function() {
    ...
    WinJS.Namespace.define("MS.Entertainment.Purchase", {
        MusicPurchaseFlowProvider: MS.Entertainment.UI.Framework.define(null, {
            getPurchaseFlow: function getPurchaseFlow(mediaItem, serviceId, target, purchaseType, offerId, returnUri, gamerTag) {
