...
(function() {
    ...
    WinJS.Namespace.define("MS.Entertainment.UI.Controls", {
        WebHostPurchasePrompt: MS.Entertainment.UI.Framework.defineUserControl("/Controls/WebHost.html#webHostPurchasePromptTemplate", function webHostPurchasePromptConstructor(element, options) {}, {
    ...
    WinJS.Namespace.define("MS.Entertainment.UI.Controls", {
        WebHost: MS.Entertainment.UI.Framework.defineUserControl("/Controls/WebHost.html#webHostTemplate", function(element, options) {
            ...
            _signIn: null,
            _eventProvider: null,
            _loadAuthenticatedUrlOnInitialize: false,
            _initialized: false,
            _signInBound: false,
            _hasValidTicket: false,
            _signedInOnStart: false,
            _parentOverlay: null,
            onIFrameLoadHandler: null,
            onReadyStateChangeHandler: null,
            title: null,
            sourceUrl: null,
            authenticatedSourceUrl: null,
            webHostExperienceFactory: null,
            webHostExperience: null,
            firstPromptOnPurchaseTitle: null,
            firstPromptOnPurchaseDescription: null,
            cancelListener: null,
            ...
            frameWidth: "100%",
            frameHeight: "100%",
            signInOverride: false,
            taskId: String.empty,
            flowId: String.empty,
            onMessage: null,
            timer: null,
            isSettingsFlow: false,
            skipPurchasePrompt: false,
            ...
            onSessionTimeout: function onSessionTimeout() {
                ...
                WinJS.Promise.timeout().then(function() {
                    var buttons = [{
                        title: String.load(String.id.IDS_YES_BUTTON),
                        isEnabled: true,
                        isAvailable: true,
                        execute: function onYes(overlay) {
                            overlay.hide();
                            that.loadAuthenticatedUrl()
                        }
                    }, {
                        title: String.load(String.id.IDS_NO_BUTTON),
                        isEnabled: true,
                        isAvailable: true,
                        execute: function onNo(overlay) {
                            overlay.hide();
            ...
            onErrorHandler: function onErrorHandler(errorCode, showError) {
                ...
                var telemetryParameterArray = [{
                    parameterName: MS.Entertainment.Utilities.Telemetry.TelemetryParameterNames.CurrentPage,
                    parameterValue: this.currentUrl || " "
                }, {
                    parameterName: MS.Entertainment.Utilities.Telemetry.TelemetryParameterNames.TaskId,
                    parameterValue: this.taskId || " "
                }, {
                    parameterName: MS.Entertainment.Utilities.Telemetry.TelemetryParameterNames.ErrorCode,
                    parameterValue: errorCode || " "
                }];
                ...
                if (config.generalSettings.promptOnPurchaseFirstRun && config.generalSettings.alwaysPromptOnPurchase && !this.isSettingsFlow && !this.skipPurchasePrompt && !MS.Entertainment.Utilities.isApp2 && (this.taskId !== MS.Entertainment.UI.Controls.WebHost.TaskId.CREATEACCOUNT) && (this.taskId !== MS.Entertainment.UI.Controls.WebHost.TaskId.TOU)) {
                    ...
                    return MS.Entertainment.UI.Shell.showDialog(firstPromptOnPurchaseTitle, "MS.Entertainment.UI.Controls.WebHostPurchasePrompt", {
                        ...
                        buttons: [WinJS.Binding.as({
                            title: String.load(String.id.IDS_WEBHOST_FIRST_PURCHASE_PROMPT_BUTTON_NEXT),
                            execute: function execute_next(dialog) {
                                dialog.userControlInstance.submit();
                                dialog.hide()
                            }
                        }), WinJS.Binding.as({
                            title: String.load(String.id.IDS_CANCEL_BUTTON_TC),
                            execute: function execute_cancel(dialog) {
                                dialog.hide()
                            }
                        })],
                        defaultButtonIndex: 0,
                        cancelButtonIndex: 1,
                        userControlOptions: {
                            description: firstPromptOnPurchaseDescription
                        }
                    })
                } else
