...
(function () {
    ...
    WinJS.Namespace.define("MS.Entertainment.UI.Controls", {
        EditBox: MS.Entertainment.UI.Framework.defineUserControl("/Controls/EditBox.html#editBoxTemplate", function (element, options) {}, {
            autoFocus: false,
            editType: null,
            _maxLength: 10,
            textChanged: null,
            ...
            selectionStart: null,
            selectionEnd: null,
            validationFailedStyle: "validationFailed",
            validationFailedText: String.empty,
            validationFailedStringId: 0,
            validationExpression: null,
            emptyStringIsValid: true,
            _showRemainingChars: false,
            watermarkText: String.empty,
            watermarkStringId: null,
            defaultValue: null,
            width: null,
            _control: null,
            _validationTimeoutInMS: 250,
            _validationTimeoutPromise: null,
            _validationRegEx: null,
            _decimalFormatter: null,
            _focusHandlers: null,
            _value: String.empty,
            value: {
            ...
            reinitialize: function create() {
                ...
                this._focusHandlers = MS.Entertainment.Utilities.addEvents(this._control, {
                    focusout: this._handleBlur.bind(this),
                    focusin: this._handleFocus.bind(this)
                });
                if (this.width)
            ...
            rows: 1,
            columns: 30,
            scratchValue: String.empty,
            defaultStringId: null,
            defaultString: null,
            disabled: false,
            isValid: false,
            isFocused: false,
    ...
    WinJS.Namespace.define("MS.Entertainment.UI.Controls", {
        EditBoxWithSubmit: MS.Entertainment.UI.Framework.deriveUserControl("MS.Entertainment.UI.Controls.EditBox", "/Controls/EditBox.html#editBoxWithSubmitTemplate", null, {
            submit: null,
            submitButtonText: String.empty,
            submitButtonStringId: null,
