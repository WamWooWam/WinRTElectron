...
@GenerateShim('Microsoft.Entertainment.Queries.TVSeasonsQueryGroupsOperation')
export class TVSeasonsQueryGroupsOperation implements ITVSeasonsQueryOperation, IAsyncOperationWithProgress<IQueryResult, number>, IAsyncInfo { 
    ...
    wait(): TVSeasonDataset {
        throw new Error('TVSeasonsQueryGroupsOperation#wait not implemented')
    }
    getResults(): IQueryResult {
        throw new Error('TVSeasonsQueryGroupsOperation#getResults not implemented')
    }
    cancel(): void {
        console.warn('TVSeasonsQueryGroupsOperation#cancel not implemented')
    }
    close(): void {
        console.warn('TVSeasonsQueryGroupsOperation#close not implemented')
    }
}
