...
@GenerateShim('Microsoft.Entertainment.Queries.TVSeriesQueryOperation')
export class TVSeriesQueryOperation implements ITVSeriesQueryOperation, IAsyncOperationWithProgress<IQueryResult, number>, IAsyncInfo { 
    ...
    wait(): TVSeriesDataset {
        throw new Error('TVSeriesQueryOperation#wait not implemented')
    }
    getResults(): IQueryResult {
        throw new Error('TVSeriesQueryOperation#getResults not implemented')
    }
    cancel(): void {
        console.warn('TVSeriesQueryOperation#cancel not implemented')
    }
    close(): void {
        console.warn('TVSeriesQueryOperation#close not implemented')
    }
}
