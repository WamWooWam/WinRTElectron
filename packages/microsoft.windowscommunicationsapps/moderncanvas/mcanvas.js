Jx.delayDefine(window, "ModernCanvas", function() {
    ...
    ModernCanvas.Component.prototype._createTextRangeIterator = function(n) {
        var i = n.startContainer, r = n.endContainer, e = n.startOffset, o = n.endOffset, s = n.commonAncestorContainer.ownerDocument, t = s.createRange(), u, f = this, h, c, l;
    ...
    ModernCanvas.Component.prototype.getSelectionRangeBoundingRect = function() {
        var t = this.getSelectionRange(), n, r, i;
    ...
    ModernCanvas.Component.prototype.getPreviousNode = function() {
        var n = this.getSelectionRange(), t;
        if (!n)
            return null;
        if (n.startOffset > 0) {
    ...
    ModernCanvas.Component.prototype.createHtmlFormat = function(n, t) {
        var o = "Version:1.0\r\nStartHTML:%08a\r\nEndHTML:%08b\r\nStartFragment:%08c\r\nEndFragment:%08d\r\n", r = o.length + 16, s = "<!DOCTYPE><HTML><HEAD>" + t + "<\/HEAD><BODY>", h = "<\/BODY><\/HTML>", u = "<!--StartFragment -->", c = "<!--EndFragment -->", f = ModernCanvas.Component.prototype._padZeros, e, i;
        if (n.indexOf(u) === -1) {
            if (t.length === 0)
    ...
    ModernCanvas.Component.prototype.getTextSearchInfo = function(n) {
        var e = this.getSelectionRange(), f, s, t;
        if (!e || !e.collapsed)
            return null;
        var i = {
            selection: e,
    ...
    function() {
        ModernCanvas.ModernCanvasBase = function(n, t) {
            ...
            u.addEventListener("mscontrolselect", i.hyperlinkManager.onClick, false);
        ...
        n._copyCore = function() {
            ...
            try {
                ...
                e && n.setText(e);
                var v = Windows.Storage.Streams.RandomAccessStreamReference, b = Windows.Foundation.Uri, y = n.resourceMap, p = i.querySelectorAll("img"), t, o, w;
                for (s = p.length; s--; )
                    t = p[s].src,
        ...
        n._localizeFromDataPackage = function(n, t, i) {
            ...
            var v = this.getElementFromNode(n.commonAncestorContainer), h = v.querySelectorAll("img"), r, y = this._regexAbsoluteUrl, f, s = 1;
            for (e = 0,
            c = h.length; e < c; e++)
                (r = h[e],
        ...
        n._constrainMaxImageSize = function(n) {
            var u = getComputedStyle(n), h = u.maxHeight, c = u.maxWidth, f = u.height, o = u.width, l = n.getComputedStyle(), r = "px", p = this._maxImageSize, t = {
                height: false,
                width: false
            }, i = 1, s = 1, e = function(n, i) {
                var u = Number(n.replace(r, ""));
                Jx.isValidNumber(u) && u < p && (t[i] = true)
            }, a = function(n, t) {
                var u = Number(n.replace(r, "")), f = Number(t.replace(r, "")), i;
        ...
        n._pasteTextLink = function(n) {
            var t = this.getSelectionRange(), r, i;
        ...
        n.getBasicSelectionStyles = function() {
            var t = this.getSelectionRange(), n;
        ...
        n.getSelectionStyles = function() {
            var i = this.getDocument(), r = this._getSelectionStyle("color"), n = this.getBasicSelectionStyles(), t;
            try {
                t = i.queryCommandValue("forecolor")
            } catch (u) {}
            return {
        ...
        n._getSelectionStyle = function(n) {
            var t = this.getSelectionRange(), h = this, f = function(t) {
                var i = t, r;
                Boolean(i.style) || (i = i.parentNode);
                do
                    r = h.getWindow().getComputedStyle(i)[n],
                    i = i.parentNode;
                while (r === "transparent" && Boolean(i.parentNode));return r === "transparent" && (r = "#ffffff"),
                r
            }, i, e;
            if (!Boolean(t))
                return Jx.log.warning("Expected a selection inside getSelectionStyle."),
                null;
            if (i = t.startContainer,
            e = t.endContainer,
            i === e && (i.childNodes.length === 0 || t.startOffset === t.endOffset))
                return f(i);
            for (var o = t.commonAncestorContainer, s = o.ownerDocument.createNodeIterator(o, NodeFilter.SHOW_TEXT, function(n) {
                var i = t.cloneRange();
                return (i.selectNodeContents(n),
                Jx.intersectsNode(t, n, true) && Boolean(n.data)) ? NodeFilter.FILTER_ACCEPT : NodeFilter.FILTER_SKIP
    ...
    Jx.delayDefine(ModernCanvas, ["RangeBookmark", "DeserializedRangeBookmark"], function() {
        ModernCanvas.RangeBookmark = function(n, t) {
            var r = n.startContainer, f = this._getCorrectedOffset(r, n.startOffset), i, u;
        ...
        n._getDirections = function(n, t, i) {
            var o = this._getNearestElement(n), s = [], r, u, f, e;
            for (o === n ? (u = 0,
        ...
        n.getBookmarkedRange = function(n) {
            var i = n.ownerDocument.createRange(), r = this._followDirections(n, this._startDirections), t;
            if (!r)
                return null;
    ...
    Jx.delayDefine(ModernCanvas, "AutoReplaceManager", function() {
        ...
        n.bulkElementConversion = function(n, t, i) {
            ...
            var v = t.length, y = ModernCanvas.NodeType, p = this._autoReplaceTables.getBulkTables().element, r, u, f, e, s, h, c = n.querySelectorAll("[data-name]");
            for (l = c.length; l--; )
                if (r = c[l],
        ...
        ModernCanvas.AutoReplaceManager.Classes = {
            "default": {
                element: {},
                realTime: [["(c)", "string", "&copy;"], ["(e)", "string", "&euro;"], ["(r)", "string", "&reg;"], ["(tm)", "string", "&trade;"], ["<--", "string", "&larr;"], ["-->", "string", "&rarr;"], ["<->", "string", "&harr;"], ["<==", "string", "&lArr;"], ["==>", "string", "&rArr;"], ["<=>", "string", "&hArr;"], ['"', "string", "&ldquo;"], ['("', "string", "(&ldquo;"], ['["', "string", "[&ldquo;"], ['{"', "string", "{&ldquo;"], ['<"', "string", "<&ldquo;"], [' "', "string", "&nbsp;&ldquo;"], ['"', "string", "&rdquo;"], ["'", "string", "&lsquo;"], [" '", "string", "&nbsp;&lsquo;"], ["('", "string", "(&lsquo;"], ["['", "string", "[&lsquo;"], ["{'", "string", "{&lsquo;"], ["<'", "string", "<&lsquo;"], ["'", "string", "&rsquo;"], ["A", "string", "&Agrave;", "grave"], ["A", "string", "&Aacute;", "acute"], ["A", "string", "&Acirc;", "circumflex"], ["A", "string", "&Atilde;", "tilde"], ["A", "string", "&Auml;", "diaeresis"], ["A", "string", "&Aring;", "ring"], ["A", "string", "&AElig;", "ligature"], ["C", "string", "&Ccedil;", "cedilla"], ["D", "string", "&ETH;", "acute"], ["E", "string", "&Egrave;", "grave"], ["E", "string", "&Eacute;", "acute"], ["E", "string", "&Ecirc;", "circumflex"], ["E", "string", "&Euml;", "diaeresis"], ["I", "string", "&Igrave;", "grave"], ["I", "string", "&Iacute;", "acute"], ["I", "string", "&Icirc;", "circumflex"], ["I", "string", "&Iuml;", "diaeresis"], ["N", "string", "&Ntilde;", "tilde"], ["O", "string", "&Ograve;", "grave"], ["O", "string", "&Oacute;", "acute"], ["O", "string", "&Ocirc;", "circumflex"], ["O", "string", "&Ouml;", "diaeresis"], ["O", "string", "&OElig;", "ligature"], ["O", "string", "&Otilde;", "tilde"], ["O", "string", "&Oslash;", "slash"], ["U", "string", "&Ugrave;", "grave"], ["U", "string", "&Uacute;", "acute"], ["U", "string", "&Ucirc;", "circumflex"], ["U", "string", "&Uuml;", "diaeresis"], ["Y", "string", "&Yacute;", "acute"], ["Y", "string", "&Yuml;", "diaeresis"], ["a", "string", "&agrave;", "grave"], ["a", "string", "&aacute;", "acute"], ["a", "string", "&acirc;", "circumflex"], ["a", "string", "&atilde;", "tilde"], ["a", "string", "&auml;", "diaeresis"], ["a", "string", "&aring;", "ring"], ["a", "string", "&aelig;", "ligature"], ["c", "string", "&ccedil;", "cedilla"], ["d", "string", "&eth;", "acute"], ["e", "string", "&egrave;", "grave"], ["e", "string", "&eacute;", "acute"], ["e", "string", "&ecirc;", "circumflex"], ["e", "string", "&euml;", "diaeresis"], ["i", "string", "&igrave;", "grave"], ["i", "string", "&iacute;", "acute"], ["i", "string", "&icirc;", "circumflex"], ["i", "string", "&iuml;", "diaeresis"], ["n", "string", "&ntilde;", "tilde"], ["o", "string", "&ograve;", "grave"], ["o", "string", "&oacute;", "acute"], ["o", "string", "&ocirc;", "circumflex"], ["o", "string", "&ouml;", "diaeresis"], ["o", "string", "&oelig;", "ligature"], ["o", "string", "&otilde;", "tilde"], ["o", "string", "&oslash;", "slash"], ["s", "string", "&szlig;", "ligature"], ["u", "string", "&ugrave;", "grave"], ["u", "string", "&uacute;", "acute"], ["u", "string", "&ucirc;", "circumflex"], ["u", "string", "&uuml;", "diaeresis"], ["y", "string", "&yacute;", "acute"], ["y", "string", "&yuml;", "diaeresis"], ["* ", "command", "bullets"], ["- ", "command", "bullets"], ["1. ", "command", "numbers"], ["1) ", "command", "numbers"]],
                bulk: {
                    outbound: [["string", "©", "string", "(c)"]]
                }
            },
            empty: {
                element: {},
    ...
    Jx.delayDefine(ModernCanvas, ["Command", "CommandManager"], function() {
        var t = window.ModernCanvas, u, n, i, r;
        ...
        n._setFontStyle = function(n, t) {
            ...
            if (s = function(i) {
                ...
                n !== "font-family" ? i.getComputedStyle()[n] !== t && (i.style[n] = t) : i.getAttribute("face") !== t && i.setAttribute("face", t)
            }
            ,
        ...
        n._clearFormatting = function(n, t) {
            var r = this.getSelectionRange(), o = null, f, u, c;
        ...
        n._getFontSizeFromSelection = function() {
            var t = this.getSelectionRange(), n = t.startContainer, r, i;
        ...
        n._doQuotedLink = function(n, t) {
            var i = this.getDocument(), r = i.createElement("a"), o = i.createElement("div"), u = this.getParent(), f, e;
        ...
        n.updateEnabledStates = function(n, t) {
            var f, i, e = this.getSelectionRange(), o = Boolean(e), u = 0, s;
    ...
    Jx.delayDefine(ModernCanvas, ["ContextMenuItem", "ContextMenuManager"], function() {
        ...
        i.onContextMenu = function(t) {
            ...
            for (f = 0; f < p.length && c < this._MaxItems; f++)
                ...
                c++);
            if (c > 0) {
                var l, a, o, v, u = this._Padding, k = this.getWindow().frameElement, w = k.getBoundingClientRect();
    ...
    Jx.delayDefine(ModernCanvas, ["HyperlinkManager", "HyperlinkTooltip"], function() {
        ...
        t.onClick = function(n) {
            var i = this.getSelectionRange(), t;
    ...
    Jx.delayDefine(ModernCanvas, "HyperlinkControl", function() {
        ...
        n._isSelectionEditable = function(n) {
            var i = n.commonAncestorContainer, u = this, r, t;
        ...
        n._expandSelection = function() {
            var n = this.getSelectionRange(), i, f, r;
            if (!n)
                return null;
            if (n = n.cloneRange(),
    ...
    Jx.delayDefine(ModernCanvas, "ShortcutManager", function() {
        ...
        t._conditionalFunctions = {
            list: function(n) {
                var i = this.getSelectionRange(), t, r;
                if (i) {
        ...
        t._getPossibleCommands = function(n) {
            var i = this._shortcuts["#|" + String(n.keyCode)] || this._shortcuts[n.key], t, e, r, u, f;
            if (!i)
                return null;
            for (t = 0,
            n.altKey && (t |= 1),
    ...
    ("Mail"in window || "Share"in window && "MailData"in window.Share) && function() {
        ...
        n._onPaste = function(n) {
            for (var u = window.clipboardData.files, i = 0, f = u.length; i < f; i++) {
                var t = u[i]
                  , e = t.slice()
        ...
        n._convertToPngStreamAsync = function(n, t, i) {
            if (n.type === "image/bmp" || n.type === "image/tiff") {
                var f = new Windows.Storage.Streams.InMemoryRandomAccessStream, r, u;
            ...
            return this._waitForImageLoadAsync(t).then(function(n) {
                var t = document.createElement("canvas"), r = t.width = n.offsetWidth, u = t.height = n.offsetHeight, f = t.getContext("2d"), i;
        ...
        n.insertSignatureIfNecessary = function(n) {
            ...
            Boolean(n) && n !== ModernCanvas.SignatureLocation.none && !Jx.isNullOrUndefined(this._mailAccount)) {
                var t = this._getSignatureHtml(), i;
