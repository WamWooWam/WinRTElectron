(function () {
    ...
    window.addEventListener("DOMContentLoaded", function () {
        (document.title = Jx.res.getString("mailAppTitle"), Jx.app = new Jx.Application(Jx.AppId.mail, true), Jx.log = new Jx.Log, Jx.log.enabled = true, Jx.log.level = Jx.LOG_VERBOSE, Mail.log("Mail_FirstAvailable"), Jx.launch.getCurrentAppStatus() !== Jx.Launch.AppStatus.mandatoryUpdate) && (WinJS.Promise.then(n(), function (n) {
            var t = Jx.root = new Mail.CompApp(n);
            t.buildUI();
            document.addEventListener("msvisibilitychange", t.handleVisibilityChange, false)
...
Jx.delayDefine(Mail, "CompApp", function () {
    ...
    var t = Mail.BaseApp,
        n;
    Mail.CompApp = function (n) {
        t.call(this, n)
    };
    n = Mail.CompApp.prototype;
    Jx.mix(n, t.prototype);
    n._onResume = function () {
        this._platform.resume()
    };
    n._onSuspend = function () {
        this._platform.suspend()
    };
    n.handleVisibilityChange = function (n) {
        n.target.msHidden || Jx.glomManager.getParentGlom().postMessage("childGlomVisible")
    };
    n.buildUI = function () {
        this._buildFrame()
    };
    n._buildFrame = function () {
        this._appState = new Mail.AppState;
        t.prototype._buildFrame.call(this, this._appState);
    ...
    n.activateUI = function () {
        ...
        var n = Jx.activation;
        this._disposer = new Mail.Disposer(new Mail.EventHook(n, n.resuming, this._onResume, this), new Mail.EventHook(n, n.suspending, this._onSuspend, this))
    };
