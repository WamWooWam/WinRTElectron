...
Jx.fault = function(n, t, i) {
    ...
    i ? (Jx.log && Jx.log.exception(r, i), Jx.isNumber(i.number) && (u = i.number)) : Jx.log && Jx.log.error(r);
    Jx.initABI();
    Jx.abi.fault(n, t, u)
};
...
Jx.promoteOriginalStack = function(n) {
    var t, i;
    n instanceof Error && (t = n.stack, Jx.isNonEmptyString(t) && (i = n.description, n.description = Jx.isNonEmptyString(i) && t.indexOf(i) === 0 ? t : JSON.stringify(i) + " " + t))
};
...
Jx.getAppNameFromId = function(n) {
    for (var r = Object.keys(Jx.AppId), u = r.length, i, t = 0; t < u; t++)
        if (i = r[t], Jx.AppId[i] === n && i !== "min") return i
};
Jx.terminateApp = function(n) {
    if (n || (n = new Error("[Jx.terminateApp: no original error]")), Jx.isString(n.description) || (n.description = n.message || "[Jx.terminateApp: no original description/message]"), !Jx.isString(n.stack)) {
...
Jx.appId = -1,
    function() {
        function i(t) {
            var r, i, u;
            return t in n || (r = "DTF:" + t, Jx._startTA(r), i = Jx.dtf(), u = t === "shortDate" ? i.shortDate : t === "longDate" ? i.longDate : t === "shortTime" ? i.shortTime : new i(t), n[t] = u, Jx._stopTA(r)), n[t]
        }
        var r, n, t;
        Jx.dtf = function() {
...
Jx.delayDefine = function(n, t, i) {
    if (Jx.isNonEmptyString(t)) Object.defineProperty(n, t, {
        get: function() {
            return Object.defineProperty(n, t, {
                value: undefined,
                writable: true
            }), Jx.mark("Jx.delayDefine:" + t + ",StartTA,Jx"), i(), Jx.mark("Jx.delayDefine:" + t + ",StopTA,Jx"), n[t]
        },
        set: function(i) {
        ...
        for (var r = 0, u = t.length; r < u; r++) Jx.delayDefine(n, t[r], i)
};
Jx._delayGroups = {};
...
Jx.delayGroupExec = function(n) {
    var r, t, i, u;
    if (r = Jx._delayGroups, t = r[n], t) {
        for (Jx.mark("Jx.delayGroupExec:" + n + ",StartTA,Jx"), i = 0, u = t.length; i < u; i++) t[i]();
...
Jx.Events = {
    initEvents: function() {
        return this._jxev = this._jxev || {}, this
    },
    ...
    removeListener: function(n, t, i) {
        var r, e, u, f;
        if (this._jxev && (f = this._jxev[n], f))
            for (r = f.listeners, u = r.length; u--;)
                if (e = r[u], Boolean(e) && e.fn === t && e.obj === i) return f.recursionCount !== 0 ? (r[u] = null, f.isSweepNeeded = true) : r.splice(u, 1), this;
        return this
    },
    hasListener: function(n) {
        var i, r, u, t, f;
        if (i = this._jxev, i && (r = i[n], r))
            for (u = r.listeners, t = 0, f = u.length; t < f; ++t)
                if (u[t]) return true;
        return false
    },
    ...
    raiseEvent: function(n, t, i) {
        var s = "Jx.Events.raiseEvent:" + n,
            f, e, r, h, u, o;
        if (Jx.mark(s + ",StartTA,Jx,Events"), i = i || {}, i.listeners = 0, o = this._jxev, o && (u = o[n], u)) {
            for (f = u.listeners, ++u.recursionCount, r = 0, h = f.length; r < h; ++r) e = f[r], e && (e.fn.call(e.obj, t), i.listeners++);
            if (--u.recursionCount == 0 && u.isSweepNeeded) {
                for (r = f.length; r--;) f[r] || f.splice(r, 1);
                u.isSweepNeeded = false
            }
        }
        return Jx.mark(s + ",StopTA,Jx,Events"), this
    }
};
    ...
    Jx.Res.prototype = {
        ...
        getFormatFunction: function(n, t) {
            function f(n, t) {
                var f = n.lastIndexOf("%") + 1,
                    ...
                    e, r;
                if (o) {
                    for (e = Math.floor(f / 2), r = 0; r < e; r++) i += "%%";
                    i += "' + arguments[" + (t - u) + "] + '"
                } else i = n;
                return i
            }
            ...
            return i = this.replaceOtherEscapes(i), new Function("return '" + i + "'")
        },
        loadCompoundString: function(n) {
            var t = this._formatFns[n];
            return t || (t = this._formatFns[n] = this.getFormatFunction(n, true)), t.apply(null, arguments)
        },
        _parseSimple: function(n) {
            for (var u = [], f = n.split(";"), t, r, o, s, i = 0, e = f.length; i < e; i++) t = f[i], t.trim() !== "" && (r = t.indexOf(":"), o = t.substring(0, r), s = t.substring(r + 1), u.push({
                destination: o.trim(),
                source: s.trim()
            }));
            return u
        ...
        _getError: function(n) {
            var t = {
                ...
                i, r;
            if (t !== undefined)
                for (i = 1, r = arguments.length; i < r; i++) t = t.replace("{" + String(i - 1) + "}", arguments[i]);
            else t = "unknown error";
            return t
        },
        _setMember: function(n, t, i) {
            for (var u = n.split("."), f = t, e = u[0], r = 1, o = u.length; r < o; r++) f = f[u[r - 1]], e = u[r];
        ...
        _process: function(n) {
            for (var u, r, t, o, f, i = 0, e = n.length; i < e; i++)
                for (u = n[i], r = this._parse(u.getAttribute("data-win-res")), t = 0, o = r.length; t < o; t++) f = this.getString(r[t].source), f !== undefined && this._setMember(r[t].destination, u, f)
        },
...
Jx.delayDefine(Jx, ["AppData", "appData"], function() {
    ...
    function i(i) {
        i._ad || (n("current"), i._ad = Windows.Storage.ApplicationData.current, t("current"))
    }
    Jx.AppData = function() {
        this._rs = null;
        this._ls = null;
    ...
    Jx.AppData.prototype = {
        ...
        localSettings: function() {
            return i(this), this._ls || (n("localSettings"), this._ls = new Jx.AppDataContainer(this._ad.localSettings), t("localSettings")), this._ls
        },
        roamingSettings: function() {
            return i(this), this._rs || (n("roamingSettings"), this._rs = new Jx.AppDataContainer(this._ad.roamingSettings), t("roamingSettings")), this._rs
        }
    };
    ...
    Jx.AppDataContainer.prototype = {
        ...
        createContainer: function(n) {
            return Jx.log.info("Jx.AppDataContainer.createContainer"), new Jx.AppDataContainer(this._adc.createContainer(n, Windows.Storage.ApplicationDataCreateDisposition.always))
        },
        ...
        get: function(n) {
            return this._values.lookup(n)
        },
        set: function(n, t) {
            return Jx.log.info("Jx.AppDataContainer.set"), this._values.insert(n, t)
        },
        remove: function(n) {
            return Jx.log.info("Jx.AppDataContainer.remove"), this._values.remove(n)
        },
        setObject: function(n, t) {
            function r(n, t) {
                var u = true,
                    f, i, e;
                for (f in n)
                    if (i = n[f], !Jx.isNullOrUndefined(i) && (Jx.isObject(i) ? (e = t.createContainer(f), u = r(i, e)) : u = Jx.isValidNumber(i) || Jx.isString(i) || Jx.isBoolean(i) ? t.set(f, i) : false, !u)) break;
                return u
            }
            var u, i;
            return (u = JSON.stringify(t), Jx.log.info("Jx.AppDataContainer.setObject"), this.deleteContainer(n), i = this.createContainer(n), !r(t, i)) ? (this.deleteContainer(i.name()), false) : true
        },
        getObject: function(n) {
            function r(n, t) {
                var i, r;
                if (t.size > 0)
                    for (i = t.first(); i.hasCurrent; i.moveNext()) r = i.current, n[r.key] = r.value
            }

            function u(n, t) {
                var i, r, u;
                if (t.size > 0)
                    for (i = t.first(); i.hasCurrent; i.moveNext()) r = i.current, u = n[r.key] = {}, f(u, r.value)
            }
            ...
            var t, i;
            return (t = this.getContainer(n), !t) ? null : (i = {}, e(i, t), i)
        },
        getValues: function() {
        ...
        _setLongString: function(n, t, i) {
            var f, r, e, o, u, s;
            if (Jx.log.info("Jx.AppDataContainer._setLongString"), this.remove(n), f = this._getSegmentContainerName(n), this.deleteContainer(f), r = true, i || (i = this._settingSize), e = t.length, e > i) {
                for (o = this.createContainer(f), u = 0, u; e > 0 && r; e -= i, u++) s = t.substr(u * i, i), r = o._values.insert(String(u), s);
                r && (r = o._values.insert("-1", u));
                r || this.deleteContainer(f)
            } else r = this._values.insert(n, t);
            return r
        },
        _getLongString: function(n) {
            var t, u, i, f, r;
            if (t = this._values.lookup(n), !t) {
                if (u = this._getSegmentContainerName(n), i = this.getContainer(u), !i) return "";
                for (f = i.get("-1"), t = "", r = 0; r < f; r++) t += i.get(String(r))
            }
            return t
        },
        setObjectInSegments: function(n, t) {
            return Jx.log.info("Jx.AppDataContainer.setObjectInSegments"), this._setLongString(n, JSON.stringify(t))
        },
        getObjectInSegments: function(n) {
            var t = this._getLongString(n);
            if (Jx.isNonEmptyString(t)) try {
                return JSON.parse(t)
            } catch (i) {
                return Jx.log.exception("Jx.AppDataContainer.getObjectInSegments: JSON failed to parse data", i), Jx.log.pii("Failing data: " + t), null
            } else return null
        }
    };
    Jx.appData = null
...
Jx.sync = function(n, t, i) {
    var r, u, f, o, e;
    for (Jx.mark("Jx.forceSync,StartTA,Jx"), Jx.log.info("Jx.forceSync.start"), r = Jx._platformNamespace || Microsoft.WindowsLive.Platform, u = n.accountManager.getConnectedAccountsByScenario(i, r.ConnectedFilter.normal, r.AccountSort.name), f = 0, o = u.count; f < o; f++) e = u.item(f), (Boolean(t) || Number(e.syncType) !== r.SyncType.manual) && Jx.forceSyncAccount(e, i);
    u.dispose();
...
Jx.forceSyncAccount = function(n, t) {
    ...
    if (i = n.getResourceByType(f), Boolean(i) && i.canEdit) {
        i.isSyncNeeded = true;
        try {
            i.commit();
            n.commit()
