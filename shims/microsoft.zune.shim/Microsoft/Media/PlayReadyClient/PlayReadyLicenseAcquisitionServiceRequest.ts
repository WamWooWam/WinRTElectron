...
@GenerateShim('Microsoft.Media.PlayReadyClient.PlayReadyLicenseAcquisitionServiceRequest')
export class PlayReadyLicenseAcquisitionServiceRequest implements IPlayReadyServiceRequest, IMediaProtectionServiceRequest { 
    contentHeader: PlayReadyContentHeader = null;
    ...
    beginServiceRequest(): IAsyncAction {
        throw new Error('PlayReadyLicenseAcquisitionServiceRequest#beginServiceRequest not implemented')
    }
    nextServiceRequest(): IPlayReadyServiceRequest {
        throw new Error('PlayReadyLicenseAcquisitionServiceRequest#nextServiceRequest not implemented')
    }
    generateManualEnablingChallenge(): PlayReadySoapMessage {
        throw new Error('PlayReadyLicenseAcquisitionServiceRequest#generateManualEnablingChallenge not implemented')
    }
    processManualEnablingResponse(responseBytes: number[]): number {
        throw new Error('PlayReadyLicenseAcquisitionServiceRequest#processManualEnablingResponse not implemented')
    }
}
