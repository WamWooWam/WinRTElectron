...
@GenerateShim('Microsoft.Entertainment.Queries.PlaylistsQueryOperation')
export class PlaylistsQueryOperation implements IPlaylistsQueryOperation, IAsyncOperationWithProgress<IQueryResult, number>, IAsyncInfo { 
    ...
    wait(): PlaylistDataset {
        throw new Error('PlaylistsQueryOperation#wait not implemented')
    }
    getResults(): IQueryResult {
        throw new Error('PlaylistsQueryOperation#getResults not implemented')
    }
    cancel(): void {
        console.warn('PlaylistsQueryOperation#cancel not implemented')
    }
    close(): void {
        console.warn('PlaylistsQueryOperation#close not implemented')
    }
}
