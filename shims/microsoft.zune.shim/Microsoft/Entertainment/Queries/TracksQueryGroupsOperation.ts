...
@GenerateShim('Microsoft.Entertainment.Queries.TracksQueryGroupsOperation')
export class TracksQueryGroupsOperation implements ITracksQueryOperation, IAsyncOperationWithProgress<IQueryResult, number>, IAsyncInfo { 
    ...
    wait(): TrackDataset {
        throw new Error('TracksQueryGroupsOperation#wait not implemented')
    }
    getResults(): IQueryResult {
        throw new Error('TracksQueryGroupsOperation#getResults not implemented')
    }
    cancel(): void {
        console.warn('TracksQueryGroupsOperation#cancel not implemented')
    }
    close(): void {
        console.warn('TracksQueryGroupsOperation#close not implemented')
    }
}
