...
import { ISignOutCompletedEventArgs } from "./ISignOutCompletedEventArgs";
import { GenerateShim } from "winrt/Windows/Foundation/Interop/GenerateShim";

@GenerateShim('Microsoft.Entertainment.Util.SignOutCompletedEventArgs')
export class SignOutCompletedEventArgs implements ISignOutCompletedEventArgs { 
    signOutResult: number = null;
}
