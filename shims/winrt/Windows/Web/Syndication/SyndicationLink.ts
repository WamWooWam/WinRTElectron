...
@GenerateShim('Windows.Web.Syndication.SyndicationLink')
export class SyndicationLink implements ISyndicationNode { 
    uri: Uri = null;
    title: string = null;
    ...
    // constructor();
    // constructor(uri: Uri);
    // constructor(uri: Uri, relationship: string, title: string, mediaType: string, length: number);
    constructor(...args) { }
    getXmlDocument(format: SyndicationFormat): XmlDocument {
        throw new Error('SyndicationLink#getXmlDocument not implemented')
    }
}
