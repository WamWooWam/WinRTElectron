...
@GenerateShim('Microsoft.Media.Advertising.FWNonTemporalAdSlot')
export class FWNonTemporalAdSlot implements IFWAdSlot, IStringable { 
    ...
    toString(): string {
        throw new Error('FWNonTemporalAdSlot#toString not implemented')
    }
}
