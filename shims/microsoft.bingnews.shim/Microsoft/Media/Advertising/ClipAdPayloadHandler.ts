...
@GenerateShim('Microsoft.Media.Advertising.ClipAdPayloadHandler')
export class ClipAdPayloadHandler implements IAdPayloadHandler, IStringable { 
    static readonly adType: string = null;
    readonly supportedTypes: string[] = null;
    player: IPlayer = null;
    preloadAdAsync(adSource: IAdSource): IAsyncAction {
        return AsyncAction.from(async () => console.warn('ClipAdPayloadHandler#preloadAdAsync not implemented'));
    }
    playAdAsync(adSource: IAdSource, startTimeout: number | null): IAsyncActionWithProgress<AdStatus> {
        return AsyncActionWithProgress.from(async () => console.warn('ClipAdPayloadHandler#playAdAsync not implemented'));
    }
    cancelAd(force: boolean): IAsyncOperation<boolean> {
        return AsyncOperation.from(async () => { throw new Error('ClipAdPayloadHandler#cancelAd not implemented') });
    }
    toString(): string {
        throw new Error('ClipAdPayloadHandler#toString not implemented')
    }
