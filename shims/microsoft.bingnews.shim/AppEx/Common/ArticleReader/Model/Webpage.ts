...
@GenerateShim('AppEx.Common.ArticleReader.Model.Webpage')
export class Webpage implements IArticle, IStringable { 
    nextArticle: IArticleInfo = null;
    previousArticle: IArticleInfo = null;
    metadata: IArticleInfo = null;
    toString(): string {
        throw new Error('Webpage#toString not implemented')
    }
}
