...
@GenerateShim('Microsoft.WindowsLive.Platform.Private.MailChangeItem')
export class MailChangeItem implements IObject { 
    ...
    commit(): void {
        console.warn('MailChangeItem#commit not implemented')
    }
    deleteObject(): void {
        console.warn('MailChangeItem#deleteObject not implemented')
    }
    getKeepAlive(): ITransientObjectHolder {
        throw new Error('MailChangeItem#getKeepAlive not implemented')
    }
