...
@GenerateShim('Microsoft.WindowsLive.Platform.Private.MailVisibility')
export class MailVisibility implements IObject { 
    ...
    commit(): void {
        console.warn('MailVisibility#commit not implemented')
    }
    deleteObject(): void {
        console.warn('MailVisibility#deleteObject not implemented')
    }
    getKeepAlive(): ITransientObjectHolder {
        throw new Error('MailVisibility#getKeepAlive not implemented')
    }
