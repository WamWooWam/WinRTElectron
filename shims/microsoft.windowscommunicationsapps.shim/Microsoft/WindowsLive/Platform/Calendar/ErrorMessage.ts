...
export class ErrorMessage implements IObject, IDisposable, IErrorMessage { 
    ...
    commit(): void {
        console.warn('ErrorMessage#commit not implemented')
    }
    deleteObject(): void {
        console.warn('ErrorMessage#deleteObject not implemented')
    }
    getKeepAlive(): ITransientObjectHolder {
        throw new Error('ErrorMessage#getKeepAlive not implemented')
    }
    dispose(): void {
        console.warn('ErrorMessage#dispose not implemented')
    }
